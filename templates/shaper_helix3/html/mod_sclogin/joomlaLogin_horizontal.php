                    ...
                    <div class="controls">
                        <div class="input-append">
                            <input name="username" tabindex="0" <?php echo $params->get('autoFocusUsername') ? 'autofocus' : '';?> alt="username" type="text" class="sclogin-username input-small"
                                   placeholder="<?php echo Text::_('MOD_SCLOGIN_USERNAME'); ?>" required aria-required="true">
                    ...
                    <div class="controls">
                        <div class="input-append">
                            <input name="<?php echo $passwordName; ?>" tabindex="0" alt="password" type="password" class="sclogin-passwd input-small"
                                   placeholder="<?php echo Text::_('MOD_SCLOGIN_PASSWORD') ?>" required aria-required="true">
                            <?php echo $helper->getForgotPasswordButton(); ?>
                        </div>
                    </div>
                </div>
                <div class="control-group pull-left" id="form-sclogin-submitcreate">
                    <button type="submit" name="Submit" class="btn btn-primary"><?php echo Text::_('MOD_SCLOGIN_LOGIN') ?></button>
                    <?php if ($showRegisterLinkInLogin) : ?>
                        <a class="btn" href="<?php echo $helper->registerLink; ?>"><?php echo Text::_('MOD_SCLOGIN_REGISTER_FOR_THIS_SITE'); ?></a>
                    <?php endif; ?>
                </div>

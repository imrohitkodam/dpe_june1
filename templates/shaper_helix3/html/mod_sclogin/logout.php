...
if ($params->get('greetingName') != 2)
{
    ...
    if ($params->get('greetingName') == 0)
        ...
        $name = $user->get('name');
    echo '<div class="sclogin-greeting sclogin-text">' . Text::sprintf($name) . '</div>';
}
...
if ($params->get('showLogoutButton'))
{
    ...
    <div class="sclogout-button">
        <div class="sclogin-joomla-login">
            <form action="<?php echo Route::_('index.php', true, $params->get('usesecure'));?>" method="post" id="sclogin-form">

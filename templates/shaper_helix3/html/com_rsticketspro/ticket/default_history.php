...
if ($this->otherTickets)
{
	...
	<table class="adminlist table table-striped=" id="articleList">
		...
		{
			$alias = OutputFilter::stringURLSafe($ticket->subject); ?>
			<tr class="row<?php echo $i % 2; ?>">
				<td>[<?php echo $this->escape($ticket->code); ?>] <a href="<?php echo RSTicketsProHelper::route('index.php?option=com_rsticketspro&view=ticket&id='.$ticket->id.':'.$alias); ?>" title="<?php echo $this->escape($ticket->subject); ?>"><?php echo $this->escape($ticket->subject); ?></a></td>

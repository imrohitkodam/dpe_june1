...
$controlGroupDivClass = ($isSubForm) ? 'row form-group' : 'col-xs-12 col-md-6';
$labelDivClass = ($isSubForm) ? 'field-label col-md-2 col-sm-12' : 'col-xs-12';
$controlDivClass = ($isSubForm) ? 'field-data col-md-8 col-sm-12' : 'col-xs-12';
						...
						<?php }?>
										<div class="form-fieldset-area py-10">
											<div class="<?php echo $controlGroupDivClass;?>">
												...
												<?php }elseif($fieldTags->type =='Spacer'){}else{ ?>

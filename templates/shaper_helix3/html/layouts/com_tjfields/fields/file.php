...
if ($field->value)
{
	...
	$uploadPath    = ($xmlField['uploadpath'] instanceof SimpleXMLElement) ? $xmlField['uploadpath']->__toString() : '';

	$widthHeight = "";

	if ($uploadPath && strtolower($field->type) == 'captureimage')
	{
		$absoluteImgPath = $uploadPath . $field->value;
	...
	{
		echo "<div><strong class=''><a href=" . $mediaLink . ">" . $fileTitle . "</a></strong></div>";
	}
	else
	{

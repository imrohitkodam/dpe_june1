...
<div class="row subform-repeatable-group subform-repeatable-group-<?php echo $unique_subform_id; ?>"
    ...
    <div class="btn-toolbar pull-right btn-group text-right mt-10 mb-20">
        <?php if (!empty($buttons['add'])) : ?><a
            class="group-add-<?php echo $unique_subform_id; ?> btn btn-sm button btn-success"><span
                class="fa fa-2x fa-plus"></span> </a><?php endif; ?>
        <?php if (!empty($buttons['remove'])) : ?><a
            class="group-remove-<?php echo $unique_subform_id; ?> btn btn-sm button btn-danger"><span
                class="fa fa-2x fa-trash"></span> </a><?php endif; ?>
        <?php if (!empty($buttons['move'])) : ?><a
            class="group-move-<?php echo $unique_subform_id; ?> btn btn-sm button btn-primary"><span
                class="fa fa-2x fa-move"></span> </a><?php endif; ?>
    </div>
	</div>
    <?php endif; ?>
    ...
    <?php
		...
		$col = str_replace('control-label', 'col-xs-12 col-md-4', $form);

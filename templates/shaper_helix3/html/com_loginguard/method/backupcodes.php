...
<a class="btn btn-danger" href="<?= Route::_(sprintf("index.php?option=com_loginguard&task=method.regenbackupcodes&user_id=%s&%s=1%s", $this->user->id, Session::getFormToken(), empty($this->returnURL) ? '' : '&returnurl=' . $this->returnURL)) ?>">

...
?>
<div id="loginguard-methods-list-container" class="row d-flex flex-wrap">
	<?php foreach($this->methods as $methodName => $method): ?>
		<div class="col-md-3 col-sm-6 col-xs-12 mb-15 d-flex ">
			<div class="loginguard-methods-list-method loginguard-methods-list-method-name-<?= htmlentities($method['name'])?> <?= ($this->defaultMethod == $methodName) ? 'loginguard-methods-list-method-default' : ''?> w-100">
				<div class="loginguard-methods-list-method-header">
					...
					<div class="d-inline-block">
						<div class="loginguard-methods-list-method-title d-inline-block">
							<h4>
								<?= $method['display'] ?>
						...
						<div class="loginguard-methods-list-method-info d-inline-block">

...
{
	$certificateUser = Factory::getUser($this->item->user_id);
}
?>
<form action="" class="form-validate form-horizontal ucm-form-styling"
		...
		<div class="row">
			<div class="col-sm-6">
				...
				<?php
					...
					if ($this->isAgencyEnabled && $this->manage && empty($this->item->id))
					{?>
						<div class="alert alert-info"><?php echo Text::_('COM_TJCERTIFICATE_ORGANIZATION_FILTER_NOTE');?></div>
					<?php 

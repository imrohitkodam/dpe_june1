...
<?php endif; ?>
<?php echo HTMLHelper::_('content.prepare' ,'{loadposition footer-top}'); ?>
</article>
<script type="text/javascript">
	
	if (jQuery('#jma-emails').length) {
    jQuery('.addtoany_container, .page-header, .entry-header').css('display', 'none');
	}

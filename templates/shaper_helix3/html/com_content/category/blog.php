...
<div class="blog<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="http://schema.org/Blog">
	...
	<?php if (!empty($this->lead_items)) : ?>
		<div class="items-leading clearfix">
			<?php foreach ($this->lead_items as &$item) : ?>
				<?php if ($item->state == 1) : ?>
				<article class="item leading-<?php echo $leadingcount; ?><?php echo $item->featured ? ' item-featured' : ''; ?>"
	...
	<?php if (!empty($this->intro_items)) : ?>
		...
		<div class="article-list">
			...
			<?php foreach ($this->intro_items as $key => &$item) : ?>
				<?php if ($item->state == 1) : ?>
				<div class="col-lg-<?php echo round(12 / $this->params->get('num_columns')); ?> mb-4">
					<div class="blog-cover h-100">
						<article class="item"
	...
	<?php if (($this->params->def('show_pagination', 1) == 1 || ($this->params->get('show_pagination') == 2)) && ($this->pagination->pagesTotal > 1)) : ?>
		<nav class="pagination-wrapper pager">

...
$paramsCharacter = ComponentHelper::getParams('com_dpe');
$characterLimit = (int) $paramsCharacter->get('allowed_character_limit');

$articleParams = ComponentHelper::getParams('com_content');
...
<div class="content-cover p-10">
	...
	<div class="introtext">
  <?php
  $introText = strip_tags($this->item->introtext,'<br><p>');

  if (strlen( $introText) > $characterLimit)
		  {
		    echo substr( $introText,0, $characterLimit);
		  }
  else
  {
    echo  $introText;
...
<!--To show Read more button for all the articels -->

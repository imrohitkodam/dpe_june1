...
<form  method="post" name="adminForm" id="adminForm" class="form-horizontal">
	<div class="modal-content tjlms-filters">
		...
		<?php	 }else{ ?>
				...
				<div class="row-fluid show-assignment-fields ">
					...
					<div class="span6 col-md-6 date-fields">
						...
						$calendar = JHTML::_("calendar", $startDate , 'start_date', 'start_date', '%Y-%m-%d', array('placeholder' => Text::_("COM_TJLMS_START_DATE") , 'class' => 'required input-medium'));
		...
		<div class="modal-body" id="enrollusers">
					...
					<?php if ($this->type != 'reco'): ?>
						<?php echo HTMLHelper::_('bootstrap.startTabSet', 'myTab', array('active' => 'users')); ?>
							<?php echo HTMLHelper::_('bootstrap.addTab', 'myTab', 'users', Text::_('COM_TJLMS_TITLE_USERS_ASSIGNMENT', true)); ?>
								<div><?php echo HTMLHelper::_('select.genericlist', $this->courseoptions, 'selectedcourse[]', 'class="btn input-medium" multiple="multiple" size="10" name="groupfilter"', "value", "text", $this->course_id);?>
								</div>
								<?php

...
?>
		<div id="lesson_format">
			...
			<div class="lesson_format row" id="<?php echo $this->format ?>">
				<div class="form-group mb-20 hide">
					<div class="col-sm-3">
					...
					<div class="col-sm-9" id="<?php echo $lesson_format ?>_subformat_options">
						<?php
				...
				foreach ($this->subformatOptions as $ind => $plugin)
				{
					...
					PluginHelper::importPlugin($format, $plugin['id']);

					// Call the plugin and get the result
					$results = Factory::getApplication()->triggerEvent(
							'onGetSubFormat_' . $plugin['id'] . 'ContentHTML',
							array($this->moduleId, $this->item->id, $this->item, $this->params, $this->formId)
						);
					?>
					<?php
						$class = "hide";

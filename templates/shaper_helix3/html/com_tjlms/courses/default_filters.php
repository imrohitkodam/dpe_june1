		...
		<div class="col-12 col-sm-9 px-0">
			<div id="filter-bar">
				<?php if ($this->menuparams->get('search') == 1) : ?>
					...
					<div class="filter_search d-inline-block valign-top mb-10 pr-5">
						<div class="float-left">
							<div class="input-group <?php echo $filterClass;?> " data-id="filter-search">
								...
								class="form-control hasTooltip" title="<?php echo Text::_('JSEARCH_FILTER'); ?>"/>

								<span class="d-table-cell valign-middle filter-search-btn">
									<button type="submit" class="btn btn-primary hasTooltip btn-custom-small"
						...
						<button type="button" class="btn hasTooltip hidden-md hidden-lg mr-5 float-right mb-5" title="<?php echo Text::_('JSEARCH_FILTER_CLEAR'); ?>" onclick="tjlmsfilter.reset();this.form.submit();">

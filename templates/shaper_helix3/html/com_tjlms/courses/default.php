...
<div class="<?php echo COM_TJLMS_WRAPPER_DIV; ?> com_tjlms_content container-fluid">
		...
		<hr class="hr hr-condensed mt-0 mb-0 d-block d-sm-none" />

		<div class="row pt-2 pb-2 mb-2 bg-eee d-flex d-sm-none" data-identifier="tjlms-filters-menu">
			<div class="col-6">
		...
		<div class="row tjlms-filters tjBs3">
			<div class="col-12">
				<?php
		...
		<div class="row">
			...
			<div class="<?php echo $tjlmsCoursesDiv;?> tjlms-courses">
				...
				?>
				<div id="tjlms_pin_container" class="<?php echo $coursesContainerClass;?> row mt-3">
					<?php
						if (!empty($courses))
						{
							...
							foreach($courses as $data)
							{
								...
								if (PluginHelper::isEnabled('tjlms', 'courseprerequisite'))
								{
									...
									$checkPrerequisiteCourseStatus = Factory::getApplication()->triggerEvent('checkPrerequisiteCourseStatus', array($data->id, $this->ol_user->id));

...
<div class="<?php echo JMAILALERTS_WRAPPER_CLASS; ?>" id="jma-emails">
	...
	<form action="" class="form-validate form-horizontal" method="POST" id="adminform" name="adminform" ENCTYPE="multipart/form-data">
		<div class="card <?php echo (!$this->user->id) ? 'guestsubscribe' : '';?>">
			<div class="card-body">
				...
				<?php if ($this->params->get('intro_msg') != '' && ($this->user->id)): ?>
					<div class="mb-3 row">
						<div class="m-1">
					...
					<?php if (trim($this->cntalert) != 0 ): ?>
						<div class="form-actions text-center">
							<button class="btn btn-primary validate" type="submit">
								<?php echo ($this->user->id)?Text::_('BUTTON_SAVE'):Text::_('BUTTON_SAVE_GUEST_USER'); ?>
							</button>
						</div>
					<?php endif; ?>
				</div>

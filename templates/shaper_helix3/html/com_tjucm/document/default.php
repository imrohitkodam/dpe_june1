...
<?php
        //DPE hack can go in core
		if (empty($this->item->fieldData['records']))
        {
			echo '<div class="alert alert-warning">' . 
				Text::_('COM_TJUCM_DOCUMENT_NORECORD_FOUND') . 
				'</div>';
			echo '<script>document.getElementById("loader-overlay").style.display = "none";</script>';
...
<div class="tj-ucm-document-container">
	...
	<div class="sticky-btn-cover text-end">
	...
	<div class="tj-ucm-document pt-5" id="tj-ucm-document">

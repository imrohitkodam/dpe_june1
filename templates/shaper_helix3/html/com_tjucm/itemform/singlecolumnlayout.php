...
<?php }
	...
	<div>
		...
		//  DPE - Hack - Code to display the form
			echo $this->loadTemplate('extrafieldssinglecolumnlayout');
			?>
		...
		<div class="col-xs-12 logcomment">
				<?php		// DPE - Hack - Start - To show comments
				echo ($this->event->afterDisplayContent)?$this->event->afterDisplayContent:'';?>		
			</div>
...
if (jQuery('#element').val() == 'com_tjucm.monitoringcompliancemakingtherounds')
{ 

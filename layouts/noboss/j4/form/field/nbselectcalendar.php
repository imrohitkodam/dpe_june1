...
// Select multiplo
if($multiple){
    $attr2 .= ' placeholder="' . $this->escape($hint ?: Text::_('LIB_NOBOSS_FIELD_IDCALENDAR_PLACEHOLDER')) . '" ';
}
// Select de uma opcao somente
else{
    // Acrescenta option no inicio com texto 'Selecione ou digite....'
    $option = new stdClass();
    $option->value = '';
    $option->text = Text::_('LIB_NOBOSS_FIELD_IDCALENDAR_PLACEHOLDER');
    array_unshift($options, $option);
}

// Tag que permite criar novo item digitando
$attr2 .= ' allow-custom';

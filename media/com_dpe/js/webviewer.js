!(function (e, t) {
    ...
    return (function (e) {
        ...
        function (e, t, n) {
            ...
            var o = {},
                i = 0;
            "undefined" == typeof console && (window.console = { log: function () {}, warn: function () {}, error: function () {} });
            var r = function () {
            ...
            window.PDFNet &&
                !o.skipPDFNetWebViewerWarning &&
                console.warn("PDFNet.js and WebViewer.js have been included in the same context. See https://www.pdftron.com/kb_same_context for an explanation of why this could be an error in your application.");
            var c = new Map(),
                d = new Map();
            o.WebViewer = function (e, t) {
                ...
                t.addEventListener("ready", function e() {
                    ...
                    "legacy" === e.ui && (e.uiPath = "./ui-legacy/index.html"),
                    e.fullAPI &&
                        e.pdftronServer &&
                        (e.forceClientSideInit ||
                            console.warn(
                                "The fullAPI and pdftronServer options have both been set so the forceClientSideInit option is now enabled. This means that WebViewer will switch to client side rendering and processing to allow use of the full API."
                            ),
                        (e.forceClientSideInit = !0)),
                    (this.options = r({}, o.WebViewer.Options, e));
                ...
                (this.messageHandler = function (t) {
                    if (("requestl" === t.data && t.source && t.source.postMessage({ type: "responsel", value: e.l || e.licenseKey }, "*"), "requestConfig" === t.data.type && t.data.id === a.id && t.source)) {
            ...
            var l = { licenseKey: void 0, enableAzureWorkaround: !1, isAdminUser: !1, isReadOnly: !1 };
            (o.WebViewer.prototype = {
                ...
                _viewerLoaded: function (e) {
                    ...
                    try {
                        ...
                        if ((n.postMessage({ type: "viewerLoaded" }, "*"), void 0 !== this.options.encryption)) {
                            var o = decodeURIComponent(this.options.initialDoc),
                                i = { decrypt: n.CoreControls.Encryption.decrypt, decryptOptions: this.options.encryption, documentId: this.options.documentId, extension: "xod" };
                            this.loadDocument(o, i);
                        }
                        null === this.instance.docViewer.getDocument()
                            ? n.addEventListener("documentLoaded", function () {
                                  t._trigger("documentLoaded");
                              })
                            : this._trigger("documentLoaded"),
                            ["displayModeChanged", "layoutModeChanged", "zoomChanged", "pageChanged", "fitModeChanged", "toolModeChanged", "rotationChanged", "finishedSavingPDF", "documentMerged"].forEach(function (e) {
                ...
                _getHTML5OptionsURL: function () {
                    var e,
                        ...
                        i = "";
                    if (
                        (o.initialDoc && (i += "#d=".concat(o.initialDoc)),
                        void 0 === o.backendType && (o.backendType = o.pdfBackend),
                        o.documentType && "xod" === o.documentType && (e = o.documentType),
                        o.preloadWorker && "xod" === o.preloadWorker && (e = o.preloadWorker),
                        o.extension && (e = o.extension),
                        e && (i += "&extension=".concat(e)),
                        o.documentType && "xod" !== o.documentType && (t = o.documentType),
                        o.preloadWorker && "xod" !== o.preloadWorker && (t = o.preloadWorker),
                        t && (i += "&preloadWorker=".concat(t)),
                        o.backendType && (i += "&pdf=".concat(o.backendType, "&office=").concat(o.backendType)),
                        o.filename && (i += "&filename=".concat(o.filename)),
                        void 0 !== o.streaming && (i += "&streaming=".concat(o.streaming)),
                        o.externalPath)
                    ) {
                    ...
                    (o.disableI18n && (i += "&disableI18n=1"),
                    o.enableOfflineMode && (i += "&offline=1"),
                    o.startOffline && (i += "&startOffline=1"),
                    (o.enableReadOnlyMode || o.isReadOnly) && (i += "&readonly=1"),
                    o.hideAnnotationPanel && (i += "&hideAnnotationPanel=1"),
                    o.disableToolGroupReordering && (i += "&disableToolGroupReordering=1"),
                    void 0 !== o.annotationUser && (i += "&user=".concat(o.annotationUser)),
                    (void 0 === o.annotationAdmin && void 0 === o.isAdminUser) || (i += "&admin=".concat(o.annotationAdmin || o.isAdminUser ? 1 : 0)),
                    void 0 !== o.custom && (i += "&custom=".concat(encodeURIComponent(o.custom))),
                    (void 0 === o.showLocalFilePicker && void 0 === o.enableFilePicker) || (i += "&filepicker=".concat(o.showLocalFilePicker || o.enableFilePicker ? 1 : 0)),
                    void 0 !== o.fullAPI && (i += "&pdfnet=".concat(o.fullAPI ? 1 : 0)),
                    void 0 !== o.enableRedaction && (i += "&enableRedaction=".concat(o.enableRedaction ? 1 : 0)),
                    void 0 !== o.enableMeasurement && (i += "&enableMeasurement=".concat(o.enableMeasurement ? 1 : 0)),
                    void 0 !== o.showToolbarControl && (i += "&toolbar=".concat(o.showToolbarControl ? "true" : "false")),
                    void 0 !== o.showPageHistoryButtons && (i += "&pageHistory=".concat(o.showPageHistoryButtons ? 1 : 0)),
                    void 0 !== o.notesInLeftPanel && (i += "&notesInLeftPanel=".concat(o.notesInLeftPanel ? 1 : 0)),
                    void 0 !== o.xdomainProxyUrl) && ((n = "string" == typeof o.xdomainProxyUrl ? { url: o.xdomainProxyUrl } : o.xdomainProxyUrl), (i += "&xdomain_urls=".concat(encodeURIComponent(JSON.stringify(n)))));
                    return (
                        (o.azureWorkaround || o.enableAzureWorkaround) && (i += "&azureWorkaround=1"),
                        o.useDownloader || (i += "&useDownloader=0"),
                        o.disableWebsockets && (i += "&disableWebsockets=1"),
                        o.disableStreaming && (i += "&disableStreaming=1"),
                        o.forceClientSideInit && (i += "&forceClientSideInit=1"),
                        o.loadAsPDF && (i += "&loadAsPDF=1"),
                        void 0 !== o.workerTransportPromise && (i += "&useSharedWorker=".concat(o.workerTransportPromise ? "true" : "false")),
                        void 0 !== o.pdftronServer && o.pdftronServer && (i += "&pdftronServer=".concat(encodeURIComponent(o.pdftronServer))),
                        o.fallbackToClientSide && (i += "&fallbackToClientSide=1"),
                        void 0 !== o.singleServerMode && (i += "&singleServerMode=".concat(o.singleServerMode ? "true" : "false")),
                        void 0 !== o.accessibleMode && (i += "&accessibleMode=".concat(o.accessibleMode ? 1 : 0)),
                        o.disableLogs && (i += "&disableLogs=1"),
                        o.enableViewStateAnnotations && (i += "&enableViewStateAnnotations=1"),
                        o.disableFlattenedAnnotations && (i += "&disableFlattenedAnnotations=1"),
                        o.highContrastMode && (i += "&highContrastMode=1"),
                        void 0 !== o.selectAnnotationOnCreation && (i += "&selectAnnotationOnCreation=".concat(o.selectAnnotationOnCreation ? 1 : 0)),
                        (i += "&id=".concat(this.id)).length > 0 && "&" === i[0] && (i = "#".concat(i.slice(1))),
                        i
                    );
                },
                setInstanceData: function (e) {
                    c.set(this.element, { iframe: e, l: this.options.l || this.options.licenseKey, workerTransportPromise: this.options.workerTransportPromise });
                },
                _createHTML5: function () {
                    ...
                    this.setInstanceData(n),
                        ...
                        (this.iframe = n),
                        this.options.backgroundColor && n.setAttribute("data-bgcolor", this.options.backgroundColor),
                        this.options.assetPath && n.setAttribute("data-assetpath", encodeURIComponent(this.options.assetPath)),
                        (this.loadListener = function () {
                            var t = e.iframe;
                            try {
                                (e.instance = t.contentWindow.readerControl),
                                    void 0 === e.instance
                                        ? t.contentWindow.addEventListener("viewerLoaded", function () {
                        ...
                        n.addEventListener("load", this.loadListener),
                ...
                getLayoutMode: function () {
                    ...
                    return (
                        t === n.Single
                            ? (e = o.WebViewer.LayoutMode.Single)
                            : t === n.Continuous
                            ? (e = o.WebViewer.LayoutMode.Continuous)
                            : t === n.Facing
                            ? (e = o.WebViewer.LayoutMode.Facing)
                            : t === n.FacingContinuous
                            ? (e = o.WebViewer.LayoutMode.FacingContinuous)
                            : t === n.Cover
                            ? (e = o.WebViewer.LayoutMode.FacingCoverContinuous)
                            : t === n.CoverFacing && (e = o.WebViewer.LayoutMode.FacingCover),
                        e
                    );
                },
                setLayoutMode: function (e) {
                    ...
                    e === o.WebViewer.LayoutMode.Single
                        ...
                        ? (n = t.Facing)
                        : e === o.WebViewer.LayoutMode.FacingContinuous
                        ? (n = t.FacingContinuous)
                        : e === o.WebViewer.LayoutMode.FacingCover
                        ? (n = t.CoverFacing)
                        : e === o.WebViewer.LayoutMode.FacingCoverContinuous && (n = t.Cover),
                        this.getInstance().setLayoutMode(n);
                },
                ...
                setFitMode: function (e) {
                    e === o.WebViewer.FitMode.FitWidth
                        ? this.fitWidth()
                        : e === o.WebViewer.FitMode.FitHeight
                        ? this.fitHeight()
                        : e === o.WebViewer.FitMode.FitPage
                        ? this.fitPage()
                        : e === o.WebViewer.FitMode.Zoom
                        ? this.zoom()
                        : console.warn("Unsupported fit mode: ".concat(e));
                },
                zoom: function () {
                    var e = this.getInstance().docViewer;
                ...
                loadDocument: function (e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                        n = { streaming: this.options.streaming },
                        o = r({}, n, t);
                ...
                isMobileDevice: function () {
                    return (
                        !this.isIE() &&
                        ((0 === this.scrollbarWidth() && navigator.userAgent.match(/Edge/i)) ||
                ...
                (o.WebViewer.LayoutMode = { Continuous: "Continuous", FacingCoverContinuous: "CoverContinuous", Facing: "Facing", FacingContinuous: "FacingContinuous", FacingCover: "FacingCover", Single: "SinglePage" }),
                ...
                (o.WebViewer.FitMode = { FitHeight: "FitHeight", FitPage: "FitPage", FitWidth: "FitWidth", Zoom: "Zoom" }),
                (o.WebViewer.SearchMode = { CaseSensitive: 1, WholeWord: 2, SearchUp: 4, PageStop: 8, ProvideQuads: 16, AmbientString: 32 }),
            ...
            var u = function (e, t) {
                    return new Promise(function (n, i) {
                        (e.l = e.l || e.licenseKey),
                            ...
                            (e.showLocalFilePicker = e.showLocalFilePicker || e.enableFilePicker);
                        t.addEventListener("ready", function o() {
                            t.removeEventListener("ready", o);
                            try {
                                var s = t.querySelector("iframe").contentWindow,
                                    c = s.Tools;
                                if (void 0 === c)
                                    return i(
                                ...
                                var d = a.getInstance(),
                                    l = r({}, d, {
                                        ...
                                        CoreControls: s.CoreControls,
                                        PartRetrievers: s.CoreControls.PartRetrievers,
                                        Actions: s.Actions,
                                        PDFNet: s.PDFNet,
                                ...
                                a.setCompleteInstance(l);
                                var u = Promise.resolve();
                                e.documentXFDFRetriever && (u = l.docViewer.setDocumentXFDFRetriever(e.documentXFDFRetriever)),
                                    u.then(function () {
                                        n(l);
                                    });
                            } catch (e) {

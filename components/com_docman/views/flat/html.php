...
class ComDocmanViewFlatHtml extends ComDocmanViewHtml
{
    ...
    protected function _setSearchFilterData(KViewContext $context)
    {
        ...
        // Unset the selected category in the search filter for default menu filter
        if (isset($menu->query['category']) && $query->has('category') && $query->category == $menu->query['category']) {

...
<? if ($params->track_downloads): ?>
    <?= helper('behavior.search_tracker'); ?>
<? endif; ?>
    ...
    <div class="well well-small k-filters k-filters--toggleable">
        ...
        <div class="k-checkbox-dropdown-content">
            <div class="form-group">
                <label for="<?= !empty($filter_group) ? $filter_group.'[search]' : 'search' ?>">
                ...
                <input
                    ...
                    id="<?= !empty($filter_group) ? $filter_group.'[search]' : 'search' ?>"
                    value="<?= escape($filter->search) ?>" />
            </div>

            <input type="hidden" name="<?= !empty($filter_group) ? $filter_group.'[search_fields]' : 'search_fields' ?>" value="<?= $params->enable_cf_filter ?>" />
            ...
            <? if ($params->get('show_category_filter', 1)): ?>
                <div class="form-group">
                    <label for="<?= !empty($filter_group) ? $filter_group.'[category]' : 'category' ?>" class="control-label"><?= translate('Category') ?></label>
                    <?= helper('listbox.categories', array(
                        ...
                        'attribs' => array(
                            'id' => !empty($filter_group) ? $filter_group.'[category]' : 'category',
                            'multiple' => true,
            ...
            <button class="btn btn-primary k-js-search-submit" type="submit"><?= translate('Search') ?></button>

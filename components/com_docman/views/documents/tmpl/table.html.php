    ...
    <? foreach ($documents as $document): ?>
        <tr class="docman_item" data-document="<?= $document->uuid ?>" itemscope itemtype="http://schema.org/CreativeWork">
            ...
            <td width="5" class="koowa_table__download k-no-wrap">
                ...
                <a class="btn btn-default btn-primary btn-mini btn-sm docman_track_download docman_download__button" href="<?= $document->download_link; ?>"
            ...
            <? if ($can_copy): ?>
            <td>
                <a class="btn btn-small btn-sm k-js-docman-copy" aria-label="<?= translate('Copy download link to clipboard') ?>"

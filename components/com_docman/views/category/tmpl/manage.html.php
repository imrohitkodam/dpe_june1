...
if (isset($menu) && !$menu->getParams()->get('allow_category_delete', 0) && !$category->canPerform('admin')) {
    $show_delete = false;
}
...
<?= $parentOpen; ?>
    ...
    ?>
        ...
        <a class="btn <?= $button_size ?> btn-sm btn-danger docman-deletable" href="#" rel="<?= escape(json_encode($data)) ?>">
          <?= translate('Delete') ?>
        </a>
    <? endif ?>
<?= $parentClose; ?>

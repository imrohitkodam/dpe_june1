...
class ComDocmanViewSubmitHtml extends ComDocmanViewHtml
{
    ...
    protected function _fetchData(KViewContext $context)
    {
        if ($this->getLayout() != 'success')
        {
            ...
            $page   = \Joomla\CMS\Factory::getApplication()->getMenu()->getActive();
            ...
            if (!empty($context->data->categories) && is_scalar($context->data->categories)) {
                $context->data->categories = (array) $context->data->categories;
            }
        ...
        else $context->data->page = \Joomla\CMS\Factory::getApplication()->getMenu()->getDefault();

...
return array(
    ...
    'aliases'    => array(
        ...
        'com://site/docman.template.helper.fields'            => 'com://admin/docman.template.helper.fields',
    ),
    ...
    'identifiers' => array(
        ...
        'com://site/docman.model.documents' => array(
            'state' => 'com://site/docman.model.state',
            'tag_filter_operator' => isset($config['tag_filter_operator']) ? $config['tag_filter_operator'] : null,
            'behaviors' => array(
        ...
        'event.subscriber.factory' => array(
            'subscribers' => array(
                'com://site/docman.event.subscriber.permalink' => ['token_validation' => $config['doclink']['token_validation'] ?? true],
                'com://site/docman.event.subscriber.doclink'
            )
        ),

        'com://site/docman.model.entity.document' => array(
            'file_creation_date' => isset($config['documents']['file_creation_date']) ? $config['documents']['file_creation_date'] : false
        ),

        'com://site/docman.dispatcher.http' => array(
            'limit' => array(
                'max' => isset($config['paginator']['max_limit']) ? $config['paginator']['max_limit'] : null
            )
        ),

        'com://site/docman.template.helper.paginator' => array(
            'max_limit' => isset($config['paginator']['max_limit']) ? $config['paginator']['max_limit'] : null
        ),

        'com://site/docman.controller.behavior.redirectable' => [
            'cloudfile_rewrites' => isset($config['documents']['cloudfile_rewrites']) ? $config['documents']['cloudfile_rewrites'] : true
        ],
    )
);

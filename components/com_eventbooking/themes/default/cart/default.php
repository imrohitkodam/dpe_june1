					...
					<tr>
						...
						<td class="col_quantity">
							<div class="btn-wrapper input-append<?php echo $inputGroupClass; ?>">
								<input type="number"<?php if ($item->maxQuantity !== -1) echo ' max="' . $item->maxQuantity . '"'; ?> min="0" class="form-control input-mini quantity_box" size="3" value="<?php echo $item->quantity ; ?>" name="quantity[]" <?php echo $readOnly ; ?> onchange="updateCart();" />

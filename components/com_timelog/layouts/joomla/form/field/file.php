...
$maxSize = $params->get('upload_maxsize') . ' MB';
$allowedMimes = explode(',', $params->get('upload_extensions'));

// DPE hack for upgrade to php 8
$dpeUtilities = new DpeUtilities();

foreach ($allowedMimes as $allowedMime)
{
	$allowedExt[] = $dpeUtilities->mimeToExt($allowedMime);
}

echo Text::sprintf('COM_TIMELOG_FILE_UPLOAD_ALLOWED_EXT', implode(', ', $allowedExt));

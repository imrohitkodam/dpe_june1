								...
								{ ?>
									<span >
										<span id="jlike_cancel_comment_btn<?php echo $comment->annotation_id;?>" class=" jlike_cancel_comment_btn jlike_display_none" >
											...
											<button type="button" class='btn jlike_commentbtn' onclick="SaveEditedComment(<?php echo $comment->annotation_id; ?>,<?php echo $comment->annotation_id; ?>,'<?php echo $likecontainerid;?>')"> <?php echo Text::_('COM_JLIKE_COMMENT'); ?></button>
										</span>
									</span>
								<?php
								} ?>

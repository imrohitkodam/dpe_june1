 ...
 * @since  1.6
 */
class DpeViewMatviewreport extends BaseHtmlView
{
	...
	public function display($tpl = null)
	{
		...
		$this->activeFilters = $this->get('allLogsData');
	...
	{ 
		...
		// $taskName = 'annualreports.createReport';
		// $task     = "onclick =Joomla.submitbutton('" . $taskName . "');";
		// $bar->appendButton('Custom', '<button type="button" ' . $task . ' 
		// 	class="btn btn-success createreport">
		// 		<span class="icon-plus"></span> ' . Text::_('COM_DPE_NEW_ANNUAL_COMPLIANCE_REPORT') . ' </button>'
		// 		);

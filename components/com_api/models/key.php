...
class ApiModelKey extends ApiModel
{
	...
	public function save($data) {
		...
		$creator			= Factory::getUser()->get('id');
		$table 				= Table::getInstance('Key', 'ApiTable');

		$old	= Table::getInstance('Key', 'ApiTable');
		if ($data['id']) :
			$old->load($data['id']);
		endif;

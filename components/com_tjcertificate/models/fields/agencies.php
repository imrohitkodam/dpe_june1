...
class JFormFieldAgencies extends JFormFieldList
{
	...
	protected function getOptions()
	{
		...
		// DPE hack to get agencies where the logged-in user is admin
		...
		foreach ($clusters as $cluster)
		{
			...
			{
				$addCertificate = RBACL::check($user->id, 'com_cluster', 'core.addCertificate', 'com_tjcertificate', $cluster->cluster_id);
			}
		...
		$query->where("c.id  IN ('" . implode("','", $clusterIds) . "')");

 ...
 * @since       0.0.1
 */
class TJQueue extends CliApplication
{
	...
	public function doExecute()
	{
		...
		$subject = Factory::getApplication();
		Factory::getApplication()->triggerEvent('onAfterInitialise', ['subject' => $subject]);
...
(new TJQueue())->loadConfiguration($argv);
(new TJQueue())->execute();

...
techjoomla.jQuery( document ).ready(function(){
	...
	// DPE Hack to add Filterable option to assignee field
	if (field_type == 'radio' || field_type == 'single_select' || field_type == 'multi_select' || field_type == 'list' || field_type == 'tjlist' || field_type == 'assignee' || field_type == 'numericcalculation')
	{
...
// DPE Hack - To prevent number field from scrolling
techjoomla.jQuery(document).on('wheel', 'input[type=number]', function (e) {
    if (techjoomla.jQuery(this).is(':focus')) {
        techjoomla.jQuery(this).blur();
    }
});
// End DPE Hack 

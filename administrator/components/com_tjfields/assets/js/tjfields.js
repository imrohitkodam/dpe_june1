jQuery(document).ready(function(){
    ...
    document.formvalidator.setHandler('filetype', function(value, element) {
        ...
        var tjfields_file_accept = element.accept;
        var tjfields_accept_array = tjfields_file_accept.split(",");
        var tjfields_uploadedfile = element.files[0];
        ...
        // Converting to bytes
        var tjfields_uploadSize = element.size * 1048576;
        var tjfields_filesize = element.files[0].size;
    ...
    document.formvalidator.setHandler('check_number_field', function(value, element) {
        ...
        var tjfields_maxValue = parseFloat(element.max);
        var tjfields_minValue = parseFloat(element.min);

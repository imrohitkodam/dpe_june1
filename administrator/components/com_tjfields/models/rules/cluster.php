 ...
 * @since  1.6
 */
class JFormRuleCluster extends FormRule
{
	/**
	...
	// 		{
	// 			if (RBACL::check(Factory::getUser()->id, 'com_cluster', 'core.edititem.' . $typeTable->id, 'com_cluster') || RBACL::check(Factory::getUser()->id, 'com_cluster', 'core.editallitem.' . $typeTable->id))
	// 			{
	...
	// DPE  Hack to show the cluster end
}

...
class JFormFieldtjfieldfields extends JFormFieldList
{
	...
	protected function getInput()
	{
		...
		$options[] = HTMLHelper::_('select.option', 'note', Text::_('COM_TJFIELDS_NOTE'));
		...
		$options[] = HTMLHelper::_('select.option', 'freetext', Text::_('COM_TJFIELDS_FREETEXT'));
		...
		$options[] = HTMLHelper::_('select.option', 'numericcalculation', Text::_('COM_TJFIELDS_NUMERICCALCULATION'));
		...
		$options[] = HTMLHelper::_('select.option', 'ownership', JText::_('COM_TJFIELDS_OWNERSHIP'));
		$options[] = HTMLHelper::_('select.option', 'color', JText::_('COM_TJFIELDS_COLOR'));

		// DPE - Hack - Start - To add checklist and assignee option type field
		$options[] = HTMLHelper::_('select.option', 'dpechecklist', JText::_('COM_TJFIELDS_CHECKLIST_OPTIONS'));
		$options[] = HTMLHelper::_('select.option', 'dpechecklistexpectation', JText::_('COM_TJFIELDS_CHECKLIST_EXPECTATION_OPTIONS'));
		$options[] = HTMLHelper::_('select.option', 'assignee', JText::_('COM_TJFIELDS_ASSIGNEE'));
		// DPE - Hack - End

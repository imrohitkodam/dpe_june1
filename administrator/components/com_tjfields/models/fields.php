...
class TjfieldsModelFields extends ListModel
{
	...
	protected function getListQuery()
	{
		...
		// DPE - Hack - start -To bring data based on extra filter
		// Filter by validation_class
		$validationClass = $this->getState('filter.validation_class');

		if ($validationClass)
		{
			$query->where('a.validation_class = ' . $db->quote($validationClass));
		}
		// DPE - Hack - end

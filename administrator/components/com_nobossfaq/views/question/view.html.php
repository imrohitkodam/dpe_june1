...
class NobossfaqViewQuestion extends NobossComponentsViewEdit {

    // Alias dos fieldsets que devem ter a coluna de campos exibidas na direita
    public $defaultFieldSets = ['questions'];
	...
	public function display($tpl = null) {
        ...
        $this->defaultFieldSetName = 'questions';

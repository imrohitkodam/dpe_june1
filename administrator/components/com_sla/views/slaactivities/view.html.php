...
class SlaViewSlaActivities extends HtmlView
{
	...
	{
		JToolBarHelper::title(Text::_('COM_SLAS_VIEW_SLA_ACTIVITIES'), '');
		$canDo = $this->canDo;

		if ($canDo->get('core.create'))
		{
			ToolbarHelper::addNew('slaactivity.add');
		}

		if ($canDo->get('core.edit'))
		{
			ToolbarHelper::editList('slaactivity.edit');
		}

		if ($canDo->get('core.edit.state'))
		{
			ToolbarHelper::divider();
			ToolbarHelper::publish('slaactivities.publish', 'JTOOLBAR_PUBLISH', true);
			ToolbarHelper::unpublish('slaactivities.unpublish', 'JTOOLBAR_UNPUBLISH', true);
		...
		{
			ToolbarHelper::deleteList('JGLOBAL_CONFIRM_DELETE', 'slaactivities.delete', 'JTOOLBAR_DELETE');
			ToolbarHelper::divider();
		}

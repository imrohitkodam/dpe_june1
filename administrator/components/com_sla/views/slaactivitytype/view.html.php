...
class SlaViewSlaActivityType extends HtmlView
{
	...
	public function display($tpl = null)
	{
		...
		$this->canDo = ContentHelper::getActions('com_sla', 'slaactivitytype', $this->item->id);
	...
	protected function addToolbar()
	{
		...
		if ($layout != "default")
		{
			...
			ToolbarHelper::title(
				Text::_('COM_SLA_PAGE_' . ($checkedOut ? 'VIEW_SLA_ACTIVITY_TYPE' : ($isNew ? 'ADD_SLA_ACTIVITY_TYPE' : 'EDIT_SLA_ACTIVITY_TYPE'))),
			...
			if ($isNew)
			{
				...
				ToolbarHelper::save('slaactivitytype.save');
				ToolbarHelper::cancel('slaactivitytype.cancel');
			}
			else
			{
				...
				ToolbarHelper::cancel('slaactivitytype.cancel', 'JTOOLBAR_CLOSE');
			}
		}
		else
		{
			ToolbarHelper::title(
				Text::_('COM_SLA_PAGE_VIEW_SLA_ACTIVITY_TYPE')
			);

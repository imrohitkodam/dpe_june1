	...
	<div class="card-body card-block collapse" id="datasource_xmlparameters">
		<table  class="admintable">
			...
			<tr>
				...
				<td class="paramlist_value">
					<input type="text" name="params[images_filter_exclude]" aria-describedby="images_filter_exclude_arialbl" value="<?php echo htmlspecialchars($this->record->params->get('images_filter_exclude', 'pdf,print,email'), ENT_QUOTES, 'UTF-8');?>" size="100"/>

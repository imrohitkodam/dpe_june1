...
<div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>">
	...
	<div class="<?php echo $bootstrapHelper->getClassMapping('span6'); ?>">
		...
		<fieldset class="form-horizontal options-form">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('enable_select_event_from_modal', Text::_('EB_ENABLE_SELECT_EVENT_FROM_MODAL'), Text::_('EB_ENABLE_SELECT_EVENT_FROM_MODAL_EXPLAIN')); ?>
				</div>
				<div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('enable_select_event_from_modal', $config->get('enable_select_event_from_modal', 0)); ?>
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">

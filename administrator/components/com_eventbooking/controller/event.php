...
class EventbookingControllerEvent extends EventbookingController
{
	...
	/**
	 * DPE Hack start- Override save to auto-set price_text based on individual_price
	 */
	public function save()
	{
		// If individual_price is 0 or empty, force price_text to 'Free'
		$individualPrice = $this->input->getInt('individual_price', 0);

		if ((int) $individualPrice == 0)
		{
			$this->input->set('price_text', 'Free');
		}

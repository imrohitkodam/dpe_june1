...
<div class="k-upload__buttons k-upload__buttons--right js-more-button" style="display: none" <?= \Joomla\CMS\Factory::getApplication()->isClient('administrator') || $document->canPerform('manage') ? 'data-enabled="1"' : '' ?>>
        ...
        <div v-show="entity.storage_type !== 'remote'">
            ...
            <?= helper('com:files.uploader.container', array(
                ...
                'options'   => array(
                    ...
                    'duplicate_mode' => $document->isNew() ? 'overwrite' : object('com://admin/docman.model.entity.config')->update_mode,

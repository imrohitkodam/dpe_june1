                    ...
                    <div class="k-container">
                        ...
                        <div class="k-container__main">
                            ...
                            <fieldset>
                                ...
                                <div class="k-form-group">
                                    <label><?= translate('File update mode');?></label>
                                    <?= helper('listbox.update_mode', array(
                                        'selected' => $config->update_mode
                                    )); ?>
                                    <p class="k-form-info">
                                        <?= translate('Decide how file updates are handled if the new file has the same filename as the existing one.'); ?>
                                    </p>
                                </div>
                              
                                <div class="k-form-group">
                                    <label><?= translate('File versioning');?></label>
                                    <?= helper('select.booleanlist', array('name' => 'file_versioning', 'selected' => $config->file_versioning)); ?>
                                    <p class="k-form-info"><?=translate('Keep track of different files used in a document.')?></p>
                                </div>
                            ...
                            <fieldset style="display: none">
                                ...
                                <legend>CSV Export Fields</legend>

                                <div class="k-table-container">
                                    <div class="k-table">
                                        <table class="k-js-responsive-table">
                                            <tbody data-behavior="orderable">
                                                <? foreach ($config->csv_fields as $index => $param): ?>
                                                <?
                                                $field = key($param);
                                                $enabled = current($param);
                                                ?>
                                                <tr
                                                data-item="<?= $field ?>"
                                                data-ordering="<?= $index ?>"
                        ...
                        <div class="k-container__sub">
                            ...
                            <fieldset class="k-form-block">
                                ...
                                <div class="k-form-block__content">
                                    ...
                                    <div class="k-form-group">
                                        ...
                                        <?= helper('select.booleanlist', array('name' => 'doclink_state', 'selected' => $config->doclink_state)); ?>
                                    </div>

                                    <div class="k-form-group">
                                        <label><?= translate('Show icons before links') ?></label>
                                        <?= helper('select.booleanlist', array('name' => 'doclink_show_icon', 'selected' => $config->doclink_show_icon)); ?>
                                    </div>

                                    <div class="k-form-group">
                                        <label><?= translate('Show document size after links') ?></label>
                                        <?= helper('select.booleanlist', array('name' => 'doclink_show_size', 'selected' => $config->doclink_show_size)); ?>
                                    </div>

                                    <? // Backward compatibility for embedded players created prior to DOCman v5.x ?>
                                    <div class="k-form-group", style="display: none;">
                                        <label><?= translate('Convert audio and video links into embedded players') ?></label>
                                        <?= helper('select.booleanlist', array('name' => 'doclink_show_player', 'selected' => $config->doclink_show_player)); ?>
                                    </div>
                                </div>
                            ...
                            <fieldset class="k-form-block">
                                ...
                                <div class="k-form-block__content">
                                    ...
                                    <div class="k-form-group">
                                        <p>
                                            <a class="k-js-scan-documents k-button k-button--default <?= !$connect_support ? 'k-is-disabled' : '' ?>"
                                               <?= $connect_support ? 'href="'.route('view=batchscan').'"' : '' ?>
                                            >

            ...
            foreach ($documents as $document):
                ...
                >
                    ...
                    <td class="k-table-data--nowrap">
                        <?= helper('date.format', array('date' => $document->created_on, 'format' => translate('Date format compact'))); ?>
                    </td>
                    <? if(!parameters()->category) : ?>
                    <td>
                    ...
                    <td class="k-table-data--icon">
                        <a class="k-js-docman-copy" data-clipboard-text="<?= $document->getPermalink(); ?>" href="#">
                            <span class="k-icon-clipboard" aria-hidden="true"></span>
                            <span class="k-visually-hidden"><?= translate('Copy'); ?></span>
                        </a>
                    </td>
                </tr>
            <? endforeach; ?>

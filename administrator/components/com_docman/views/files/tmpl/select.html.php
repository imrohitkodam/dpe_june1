...
window.addEvent('domready', function(){
    ...
    kQuery('#refresh').click(function(e) {
...
<p id="document-refresh-form">
    <button class="k-button k-button--success k-button--block" type="button" id="refresh"><?= translate('Refresh') ?></button>
</p>

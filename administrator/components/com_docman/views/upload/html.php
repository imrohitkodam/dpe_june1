...
class ComDocmanViewUploadHtml extends ComDocmanViewHtml
{
    ...
    protected function _fetchData(KViewContext $context)
    {
        ...
        $context->data->admin             = \Joomla\CMS\Factory::getApplication()->isClient('administrator');
        ...
        if (!$context->data->admin)
        {
            ...
            if (!$context->data->can_manage) {
                $category_filter = array(
                    ...
                    'enabled'      => 1,
                    'own'          => isset($menu->query['own_categories']) ? $menu->query['own_categories'] : 0
                );
            }
        }
        ...
        $context->data->automatic_humanized_titles = $this->getObject('com://admin/docman.model.entity.config')->automatic_humanized_titles;

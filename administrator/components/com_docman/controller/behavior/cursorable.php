 ...
 */
class ComDocmanControllerBehaviorCursorable extends KControllerBehaviorAbstract
{
    /**
    ...
    protected function _initialize(KObjectConfig $config)
    {
        $config->append(array(
            ...
            'limit'             => 5,
            'direction'         => 'ASC',
            'behavior'          => 'com://admin/docman.database.behavior.cursorable'
        ));
    ...
    protected function _beforeRender(KControllerContextInterface $context)
    {
        ...
        if (!$this->_behavior instanceof ComDocmanDatabaseBehaviorCursorable) {
            throw new UnexpectedValueException('Behavior must be an instance of ComDocmanDatabaseBehaviorCursorable');
        }

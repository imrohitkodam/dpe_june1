...
class ComDocmanDatabaseBehaviorPermissible extends KDatabaseBehaviorAbstract
{
    ...
    public function getPermissions()
    {
        ...
        $xmlfile = JPATH_ADMINISTRATOR . '/components/' . $component . '/access.xml';
        $xpath = "/access/section[@name='" . $section . "']/";
        $actions = \Joomla\CMS\Access\Access::getActionsFromFile($xmlfile, $xpath);
    ...
    public function canPerform($action)
    {
        ...
        else
        {
            ...
            $asset_name    = $component;// DPE HAck
        }

        return (bool)$user->authorise($joomla_action, $asset_name) && !$this->_isRestricted($action);
    }

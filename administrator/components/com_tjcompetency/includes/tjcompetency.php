...
$language->load('com_tjcompetency');

/**
 * Competency factory class.
 *
...
{
	/**
	 * Holds the record of the loaded TjCompetency classes
	 *
	 * @var    array
	 * @since  1.0.0
	 */
	...
	public static $client = "com_tjcompetency";

	public static $mediaPath = "media/com_tjcompetency/";
	...
	public static function table($name)
	{
		...
		return Table::getInstance($name, 'TjCompetencyTable');
	}
	...
	{
		BaseDatabaseModel::addIncludePath(JPATH_ADMINISTRATOR . '/components/com_tjcompetency/models');

		return BaseDatabaseModel::getInstance($name, 'TjCompetencyModel', $config);
	}

	/**
	 * Magic method to create instance of TjCompetency library
	 *
	...
	public static function __callStatic($name, $arguments)
	{
		...
		$className = 'TjCompetency' . StringHelper::ucfirst($name);
	...
	public static function loadClass($className)
	{
		if (! isset(self::$loadedClass[$className]))
		{
			...
			$path = JPATH_ADMINISTRATOR . '/components/com_tjcompetency/libraries/' . $className . '.php';
	...
	public static function init($location = 'site')
	{
		...
		if ($location == 'site')
		{
			HTMLHelper::stylesheet('media/com_tjcompetency/vendors/font-awesome-4.1.0/css/font-awesome.min.css');
		}
	}

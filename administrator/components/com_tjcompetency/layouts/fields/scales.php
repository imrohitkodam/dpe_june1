 ...
 *
 * @var   string   $scaleName       The scale name
...
$uri = new JUri('index.php?option=com_tjcompetency&view=scales&layout=modal&tmpl=component&required=0&field={field-user-id}');
...
if ($this->escape($scaleName) === JText::_('COM_COMPETENCY_COMPETENCY_SKILLCONTENTMAP_FORM_SELECT_SCALE'))
{
	$scaleName = '';
}

$inputAttributes = array(
	'type' => 'text', 'id' => $id, 'class' => 'field-user-input-name', 'value' => $this->escape($scaleName)
);
...
if (!$readonly)
{
	$inputAttributes['placeholder'] = JText::_('COM_COMPETENCY_COMPETENCY_SKILLCONTENTMAP_FORM_SELECT_SCALE');
}
	...
	<div class="input-append">
		...
		<?php if (!$readonly) : ?>
			<button
				...
				title="<?php echo JText::_('COM_COMPETENCY_COMPETENCY_SKILLCONTENTMAP_FORM_SELECT_SCALE'); ?>"
				aria-label="<?php echo JText::_('COM_COMPETENCY_COMPETENCY_SKILLCONTENTMAP_FORM_SELECT_SCALE'); ?>"
				>
			...
			<?php echo JHtml::_(
				...
				'scaleModal_' . $id,
				array(
					'title'       => JText::_('COM_COMPETENCY_COMPETENCY_SKILLCONTENTMAP_FORM_SELECT_SCALE'),
					'closeButton' => true,

 ...
 * @since  1.0.0
 */
class TjCompetencyViewSkillContentUserMap extends HtmlView
{
	/**
	 * The JForm object
	 *
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(
			Text::_('COM_TJCOMPETENCY_PAGE_VIEW_COMPETENCY_SKILLCONTENTUSERMAP')
		);
		...
		if ($layout != "default")
		{
			...
			JToolbarHelper::title(
				Text::_('COM_TJCOMPETENCY_PAGE_' . ($checkedOut ? 'VIEW_COMPETENCY_SKILLCONTENTUSERMAP' :
					($isNew ? 'ADD_COMPETENCY_SKILLCONTENTUSERMAP' : 'EDIT_COMPETENCY_SKILLCONTENTUSERMAP'))
			), 'pencil-2 skillcontentusermap-add'
			);

			if ($isNew)
			{
				JToolbarHelper::apply('skillcontentusermap.apply');
				JToolbarHelper::save('skillcontentusermap.save');
				JToolbarHelper::save2new('skillcontentusermap.save2new');
			}
			else
			{
			...
			JToolbarHelper::cancel('skillcontentusermap.cancel');
		}
	...
	protected function canSave($checkedOut)
	{
		if (!$checkedOut)
		{
			...
			JToolbarHelper::save('skillcontentusermap.save');
			JToolbarHelper::save2new('skillcontentusermap.save2new');
			// JToolbarHelper::save2copy('skillcontentusermap.save2copy');
		}
	}

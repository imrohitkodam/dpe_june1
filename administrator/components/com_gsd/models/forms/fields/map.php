...
class JFormFieldMap extends FormField
{
    ...
    private function getSubform()
    {
        ...
        // Add CSS Selector options
        $xml .= '
            <field name="css_selector" type="cssselector" 
                showon="option:_css_selector_"
                hiddenLabel="true"
            />
        ';
    ...
    private function getOptionField()
    {
        ...
        // CSS Selector option
        $fixed = $el->addChild('option', 'NR_CSS_SELECTOR');
        $fixed->addAttribute('value', '_css_selector_');

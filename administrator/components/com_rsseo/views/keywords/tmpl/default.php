...
<form action="<?php echo Route::_('index.php?option=com_rsseo&view=keywords');?>" method="post" name="adminForm" id="adminForm">
	...
	<?php echo RSSeoAdapterGrid::sidebar(); ?>
		...
		<table class="table table-striped">
			...
			<thead>
				...
				<th><?php echo HTMLHelper::_('searchtools.sort', 'COM_RSSEO_KEYWORDS_KEYWORD', 'keyword', $listDirn, $listOrder); ?></th>
			...
			<tbody>
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="nowrap has-context">
						<a href="<?php echo Route::_('index.php?option=com_rsseo&task=keyword.edit&id='.$item->id); ?>">

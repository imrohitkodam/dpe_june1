				...
				<div>
					...
					if ($this->canEditMessage($message))
					{
						echo JHtml::_('bootstrap.renderModal', 'rsticketsproMessageModal'.$message->id, array(
							...
							'backdrop' => 'static'));
						?>
						<a class="btn btn-secondary btn-small btn-sm" onclick="jQuery('#rsticketsproMessageModal<?php echo $message->id; ?>').modal('show');" href="#"><i class="icon-edit"></i> <?php echo JText::_('RST_TICKET_EDIT_MESSAGE'); ?></a>
						<?php
					}

...
// DPE Hack to show the json format tag for the ucm notification configurations.
$ucmInput = Factory::getApplication()->input;
$type   = $ucmInput->get("from", '', 'STRING');

if($type == 'ucmnotification')
{
	$this->item->replacement_tags	= '[{"name":"user.name","description":"Name of the user"},{"name":"user.school","description":"Name of the school"},{"name":"log.status","description":"Status details"},{"name":"log.id","description":"Log id "},{"name":"log.url","description":"Url of the form"},{"name":"log.client","description":"Form name"}]';
}

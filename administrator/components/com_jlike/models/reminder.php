...
class JlikeModelReminder extends AdminModel
{
	...
	protected $event_after_delete = 'onAfterReminderDelete';
	...
	public function save($data)
	{
		...
		$isTodoSpecific = $input->get('jform', array(), 'array')['is_todo_specific'];
		...
		$data['is_todo_specific'] = $isTodoSpecific ; // DPE HACK TO ADD TODO SPECIFIC VALUE.
		...
		// Plugin trigger on after reminder save DPE Hack
		Factory::getApplication()->triggerEvent('onAfterReminderSave', array($data));

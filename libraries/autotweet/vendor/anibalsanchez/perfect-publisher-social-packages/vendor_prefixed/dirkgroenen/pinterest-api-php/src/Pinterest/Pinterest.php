...
namespace XTS_BUILD\DirkGroenen\Pinterest;

use XTS_BUILD\DirkGroenen\Pinterest\Auth\PinterestOAuth;
use XTS_BUILD\DirkGroenen\Pinterest\Utils\CurlBuilder;
use XTS_BUILD\DirkGroenen\Pinterest\Transport\Request;
use XTS_BUILD\DirkGroenen\Pinterest\Exceptions\InvalidEndpointException;
...
class Pinterest {
    ...
    public function __get($endpoint)
    {
        ...
        $class = "\\XTS_BUILD\\DirkGroenen\\Pinterest\\Endpoints\\" . ucfirst($endpoint);

...
class GraphNodeFactory
{
     ...
     */
    const BASE_GRAPH_NODE_CLASS = '\XTS_BUILD\Facebook\GraphNodes\GraphNode';

    /**
     * @const string The base graph edge class.
     */
    const BASE_GRAPH_EDGE_CLASS = '\XTS_BUILD\Facebook\GraphNodes\GraphEdge';

    /**
     * @const string The graph object prefix.
     */
    const BASE_GRAPH_OBJECT_PREFIX = '\XTS_BUILD\Facebook\GraphNodes\\';

...
use XTS_BUILD\Facebook\HttpClients\FacebookHttpClientInterface;
use XTS_BUILD\Facebook\HttpClients\FacebookCurlHttpClient;
use XTS_BUILD\Facebook\HttpClients\FacebookStreamHttpClient;
...
class FacebookClient
{
    ...
    {
        if (get_class($request) === 'XTS_BUILD\Facebook\FacebookRequest') {

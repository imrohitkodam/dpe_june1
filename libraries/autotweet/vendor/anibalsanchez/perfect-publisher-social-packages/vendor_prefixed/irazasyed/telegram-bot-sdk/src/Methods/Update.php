...
namespace XTS_BUILD\Telegram\Bot\Methods;

use XTS_BUILD\Telegram\Bot\TelegramResponse;
use XTS_BUILD\Telegram\Bot\Objects\WebhookInfo;
use XTS_BUILD\Telegram\Bot\FileUpload\InputFile;
use XTS_BUILD\Telegram\Bot\Events\UpdateWasReceived;
use XTS_BUILD\Telegram\Bot\Objects\Update as UpdateObject;
use XTS_BUILD\Telegram\Bot\Exceptions\TelegramSDKException;
...
trait Update
{
    ...
    public function getUpdates(array $params = [], $shouldEmitEvents = true): array
    {
        ...
        return XTS_collect($response->getResult())

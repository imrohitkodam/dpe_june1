...
namespace XTS_BUILD\Telegram\Bot;

use InvalidArgumentException;
use XTS_BUILD\Illuminate\Contracts\Container\Container;
...
class BotsManager
{
    ...
    public function getBotConfig($name = null): array
    {
        ...
        $bots = XTS_collect($this->getConfig('bots'));
    ...
    {
        return XTS_array_get($this->config, $key, $default);
    }
    ...
    {
        XTS_array_set($this->config, 'default', $name);
    ...
    protected function makeBot($name): Api
    {
        ...
        $token = XTS_array_get($config, 'token');
        ...
        $commands = XTS_array_get($config, 'commands', []);

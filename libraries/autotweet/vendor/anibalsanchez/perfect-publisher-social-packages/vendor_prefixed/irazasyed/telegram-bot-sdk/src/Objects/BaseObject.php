...
abstract class BaseObject extends Collection
{
    ...
    {
        $property = XTS_snake_case($property);
        ...
        $class = 'XTS_BUILD\Telegram\Bot\Objects\\'.XTS_studly_case($property);
    ...
    {
        return XTS_array_get($data, 'result', $data);
    }
    ...
    {
        return XTS_array_get($this->items, 'ok', false);
    }

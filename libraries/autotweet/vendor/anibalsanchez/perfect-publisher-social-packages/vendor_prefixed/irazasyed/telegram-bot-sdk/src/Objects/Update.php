...
use XTS_BUILD\Telegram\Bot\Objects\Payments\ShippingQuery;
use XTS_BUILD\Telegram\Bot\Objects\Payments\PreCheckoutQuery;
...
class Update extends BaseObject
{
    ...
    public function getChat(): Collection
    {
        ...
        return $message->has('chat') ? $message->get('chat') : XTS_collect();
    }
}

...
use XTS_BUILD\VK\Actions\Enums\Groups\AddressWorkInfoStatus;
use XTS_BUILD\VK\Actions\Enums\Groups\GroupAccess;
use XTS_BUILD\VK\Actions\Enums\Groups\GroupAgeLimits;
use XTS_BUILD\VK\Actions\Enums\Groups\GroupAudio;
use XTS_BUILD\VK\Actions\Enums\Groups\GroupDocs;
use XTS_BUILD\VK\Actions\Enums\Groups\GroupMarketCurrency;
use XTS_BUILD\VK\Actions\Enums\Groups\GroupPhotos;
use XTS_BUILD\VK\Actions\Enums\Groups\GroupRole;
use XTS_BUILD\VK\Actions\Enums\Groups\GroupSubject;
use XTS_BUILD\VK\Actions\Enums\Groups\GroupTopics;
use XTS_BUILD\VK\Actions\Enums\Groups\GroupVideo;
use XTS_BUILD\VK\Actions\Enums\Groups\GroupWall;
use XTS_BUILD\VK\Actions\Enums\Groups\GroupWiki;
use XTS_BUILD\VK\Actions\Enums\GroupsFilter;
use XTS_BUILD\VK\Actions\Enums\GroupsNameCase;
use XTS_BUILD\VK\Actions\Enums\GroupsSort;
use XTS_BUILD\VK\Actions\Enums\GroupsSubtype;
use XTS_BUILD\VK\Actions\Enums\GroupsType;
use XTS_BUILD\VK\Client\VKApiRequest;
use XTS_BUILD\VK\Exceptions\Api\VKApiAccessGroupsException;
use XTS_BUILD\VK\Exceptions\Api\VKApiCallbackApiServersLimitException;
use XTS_BUILD\VK\Exceptions\Api\VKApiCommunitiesCatalogDisabledException;
use XTS_BUILD\VK\Exceptions\Api\VKApiCommunitiesCategoriesDisabledException;
use XTS_BUILD\VK\Exceptions\Api\VKApiGroupChangeCreatorException;
use XTS_BUILD\VK\Exceptions\Api\VKApiGroupHostNeed2faException;
use XTS_BUILD\VK\Exceptions\Api\VKApiGroupNeed2faException;
use XTS_BUILD\VK\Exceptions\Api\VKApiGroupNotInClubException;
use XTS_BUILD\VK\Exceptions\Api\VKApiGroupTooManyAddressesException;
use XTS_BUILD\VK\Exceptions\Api\VKApiGroupTooManyOfficersException;
use XTS_BUILD\VK\Exceptions\Api\VKApiInvalidAddressException;
use XTS_BUILD\VK\Exceptions\Api\VKApiLimitsException;
use XTS_BUILD\VK\Exceptions\Api\VKApiNotFoundException;

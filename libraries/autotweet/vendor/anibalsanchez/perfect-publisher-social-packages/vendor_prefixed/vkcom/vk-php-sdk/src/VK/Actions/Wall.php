...
use XTS_BUILD\VK\Actions\Enums\WallFilter;
use XTS_BUILD\VK\Actions\Enums\WallReason;
use XTS_BUILD\VK\Actions\Enums\WallSort;
use XTS_BUILD\VK\Client\VKApiRequest;
use XTS_BUILD\VK\Exceptions\Api\VKApiBlockedException;
use XTS_BUILD\VK\Exceptions\Api\VKApiWallAccessAddReplyException;
use XTS_BUILD\VK\Exceptions\Api\VKApiWallAccessCommentException;
...
use XTS_BUILD\VK\Exceptions\Api\VKApiWallAddPostException;
use XTS_BUILD\VK\Exceptions\Api\VKApiWallAdsPostLimitReachedException;
use XTS_BUILD\VK\Exceptions\Api\VKApiWallAdsPublishedException;
use XTS_BUILD\VK\Exceptions\Api\VKApiWallLinksForbiddenException;
use XTS_BUILD\VK\Exceptions\Api\VKApiWallReplyOwnerFloodException;
use XTS_BUILD\VK\Exceptions\Api\VKApiWallTooManyRecipientsException;

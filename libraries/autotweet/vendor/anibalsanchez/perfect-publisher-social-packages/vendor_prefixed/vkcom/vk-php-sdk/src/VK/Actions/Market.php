...
use XTS_BUILD\VK\Actions\Enums\MarketReason;
use XTS_BUILD\VK\Actions\Enums\MarketRev;
use XTS_BUILD\VK\Actions\Enums\MarketSort;
use XTS_BUILD\VK\Actions\Enums\MarketStatus;
use XTS_BUILD\VK\Client\VKApiRequest;
use XTS_BUILD\VK\Exceptions\Api\VKApiAccessMarketException;
use XTS_BUILD\VK\Exceptions\Api\VKApiMarketAlbumNotFoundException;
use XTS_BUILD\VK\Exceptions\Api\VKApiMarketCommentsClosedException;
use XTS_BUILD\VK\Exceptions\Api\VKApiMarketGroupingItemsMustHaveDistinctPropertiesException;
use XTS_BUILD\VK\Exceptions\Api\VKApiMarketGroupingMustContainMoreThanOneItemException;
use XTS_BUILD\VK\Exceptions\Api\VKApiMarketItemAlreadyAddedException;
use XTS_BUILD\VK\Exceptions\Api\VKApiMarketItemHasBadLinksException;
use XTS_BUILD\VK\Exceptions\Api\VKApiMarketItemNotFoundException;
use XTS_BUILD\VK\Exceptions\Api\VKApiMarketPropertyNotFoundException;
use XTS_BUILD\VK\Exceptions\Api\VKApiMarketRestoreTooLateException;
use XTS_BUILD\VK\Exceptions\Api\VKApiMarketTooManyAlbumsException;
use XTS_BUILD\VK\Exceptions\Api\VKApiMarketTooManyItemsException;
use XTS_BUILD\VK\Exceptions\Api\VKApiMarketTooManyItemsInAlbumException;
use XTS_BUILD\VK\Exceptions\Api\VKApiMarketVariantNotFoundException;

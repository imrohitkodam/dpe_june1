...
namespace XTS_BUILD\Illuminate\Support\Testing\Fakes;

use XTS_BUILD\Illuminate\Contracts\Mail\Mailer;
use XTS_BUILD\Illuminate\Contracts\Mail\Mailable;
...
class MailFake implements Mailer
{
    ...
    {
        return XTS_collect($this->mailables)->filter(function ($mailable) use ($type) {

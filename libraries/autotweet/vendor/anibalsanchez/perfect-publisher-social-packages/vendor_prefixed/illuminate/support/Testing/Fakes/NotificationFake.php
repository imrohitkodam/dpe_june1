...
use XTS_BUILD\Illuminate\Contracts\Notifications\Factory as NotificationFactory;
...
class NotificationFake implements NotificationFactory
{
    ...
    public function sent($notifiable, $notification, $callback = null)
    {
        ...
        $notifications = XTS_collect($this->notificationsFor($notifiable, $notification));

...
use XTS_BUILD\Http\Message\Cookie;
use XTS_BUILD\Http\Message\CookieJar;
use XTS_BUILD\Http\Message\CookieUtil;
use XTS_BUILD\Http\Message\Exception\UnexpectedValueException;

...
use XTS_BUILD\Http\Client\Common\Exception\LoopException;
...
use XTS_BUILD\Http\Client\Promise\HttpFulfilledPromise;
use XTS_BUILD\Http\Client\Promise\HttpRejectedPromise;

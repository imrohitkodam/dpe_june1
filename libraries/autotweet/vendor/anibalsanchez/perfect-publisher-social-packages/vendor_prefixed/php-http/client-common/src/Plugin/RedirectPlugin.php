...
use XTS_BUILD\Http\Client\Common\Exception\CircularRedirectionException;
use XTS_BUILD\Http\Client\Common\Exception\MultipleRedirectionException;
use XTS_BUILD\Http\Client\Common\Plugin;
use XTS_BUILD\Http\Client\Exception\HttpException;

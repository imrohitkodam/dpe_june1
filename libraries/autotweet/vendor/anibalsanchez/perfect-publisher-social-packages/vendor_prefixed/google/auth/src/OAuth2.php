...
class OAuth2 implements FetchAuthTokenInterface
{
    ...
    {
        if (class_exists('XTS_BUILD\Firebase\JWT\JWT')) {
            return \XTS_BUILD\Firebase\JWT\JWT::decode($idToken, $publicKey, $allowedAlgs);
        }
    ...
    {
        if (class_exists('XTS_BUILD\Firebase\JWT\JWT')) {
            return \XTS_BUILD\Firebase\JWT\JWT::encode(
                $assertion,
                $signingKey,
                $signingAlgorithm,
                $signingKeyId

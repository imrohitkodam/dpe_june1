...
namespace XTS_BUILD\Google\Auth\Subscriber;

use XTS_BUILD\Google\Auth\CacheTrait;
use XTS_BUILD\GuzzleHttp\Event\BeforeEvent;
use XTS_BUILD\GuzzleHttp\Event\RequestEvents;
use XTS_BUILD\GuzzleHttp\Event\SubscriberInterface;

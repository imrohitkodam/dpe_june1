 ...
 *  </code>
 */
class XTS_Google_Service_Urlshortener_Resource_Url extends XTS_Google_Service_Resource
{
  /**
  ...
  public function get($shortUrl, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "XTS_Google_Service_Urlshortener_Url");
  }
  /**
   ...
   * @return Google_Service_Urlshortener_Url
   */
  public function insert(XTS_Google_Service_Urlshortener_Url $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "XTS_Google_Service_Urlshortener_Url");
  }
  /**
  ...
  public function listUrl($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "XTS_Google_Service_Urlshortener_UrlHistory");
  }
}

 ...
 *  </code>
 */
class XTS_Google_Service_Blogger_Resource_Posts extends XTS_Google_Service_Resource
{
  /**
  ...
  public function get($blogId, $postId, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'postId' => $postId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "XTS_Google_Service_Blogger_Post");
  }
  /**
  ...
  public function getByPath($blogId, $path, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('getByPath', array($params), "XTS_Google_Service_Blogger_Post");
  }
  /**
   ...
   * @return Google_Service_Blogger_Post
   */
  public function insert($blogId, XTS_Google_Service_Blogger_Post $postBody, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "XTS_Google_Service_Blogger_Post");
  }
  /**
  ...
  public function listPosts($blogId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "XTS_Google_Service_Blogger_PostList");
  }
  /**
   ...
   * @return Google_Service_Blogger_Post
   */
  public function patch($blogId, $postId, XTS_Google_Service_Blogger_Post $postBody, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'postId' => $postId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "XTS_Google_Service_Blogger_Post");
  }
  /**
  ...
  public function publish($blogId, $postId, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'postId' => $postId);
    $params = array_merge($params, $optParams);
    return $this->call('publish', array($params), "XTS_Google_Service_Blogger_Post");
  }
  /**
  ...
  public function revert($blogId, $postId, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'postId' => $postId);
    $params = array_merge($params, $optParams);
    return $this->call('revert', array($params), "XTS_Google_Service_Blogger_Post");
  }
  /**
  ...
  public function search($blogId, $q, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "XTS_Google_Service_Blogger_PostList");
  }
  /**
   ...
   * @return Google_Service_Blogger_Post
   */
  public function update($blogId, $postId, XTS_Google_Service_Blogger_Post $postBody, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'postId' => $postId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "XTS_Google_Service_Blogger_Post");
  }
}

 ...
 *  </code>
 */
class XTS_Google_Service_Blogger_Resource_PageViews extends XTS_Google_Service_Resource
{
  /**
  ...
  public function get($blogId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "XTS_Google_Service_Blogger_Pageviews");
  }
}

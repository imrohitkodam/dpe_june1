...
class XTS_Google_Service_Pagespeedonline_LighthouseCategoryV5 extends XTS_Google_Collection
{
  protected $collection_key = 'auditRefs';
  protected $auditRefsType = 'XTS_Google_Service_Pagespeedonline_LighthouseCategoryV5AuditRefs';

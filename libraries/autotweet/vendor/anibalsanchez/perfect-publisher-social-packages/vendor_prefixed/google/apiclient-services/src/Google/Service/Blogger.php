 ...
 * @author Google, Inc.
 */
class XTS_Google_Service_Blogger extends XTS_Google_Service
{
   ...
   */
  public function __construct(XTS_Google_Client $client, $rootUrl = null)
  {
    ...
    $this->blogUserInfos = new XTS_Google_Service_Blogger_Resource_BlogUserInfos(
        $this,
        $this->serviceName,
        'blogUserInfos',
        array(
    ...
    $this->blogs = new XTS_Google_Service_Blogger_Resource_Blogs(
        $this,
        $this->serviceName,
        'blogs',
        array(
    ...
    $this->comments = new XTS_Google_Service_Blogger_Resource_Comments(
        $this,
        $this->serviceName,
        'comments',
        array(
    ...
    $this->pageViews = new XTS_Google_Service_Blogger_Resource_PageViews(
        $this,
        $this->serviceName,
        'pageViews',
        array(
    ...
    $this->pages = new XTS_Google_Service_Blogger_Resource_Pages(
        $this,
        $this->serviceName,
        'pages',
        array(
    ...
    $this->postUserInfos = new XTS_Google_Service_Blogger_Resource_PostUserInfos(
        $this,
        $this->serviceName,
        'postUserInfos',
        array(
    ...
    $this->posts = new XTS_Google_Service_Blogger_Resource_Posts(
        $this,
        $this->serviceName,
        'posts',
        array(
    ...
    $this->users = new XTS_Google_Service_Blogger_Resource_Users(
        $this,
        $this->serviceName,
        'users',
        array(

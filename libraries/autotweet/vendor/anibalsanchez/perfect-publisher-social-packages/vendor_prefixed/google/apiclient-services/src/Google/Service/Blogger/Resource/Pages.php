 ...
 *  </code>
 */
class XTS_Google_Service_Blogger_Resource_Pages extends XTS_Google_Service_Resource
{
  /**
  ...
  public function get($blogId, $pageId, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'pageId' => $pageId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "XTS_Google_Service_Blogger_Page");
  }
  /**
   ...
   * @return Google_Service_Blogger_Page
   */
  public function insert($blogId, XTS_Google_Service_Blogger_Page $postBody, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "XTS_Google_Service_Blogger_Page");
  }
  /**
  ...
  public function listPages($blogId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "XTS_Google_Service_Blogger_PageList");
  }
  /**
   ...
   * @return Google_Service_Blogger_Page
   */
  public function patch($blogId, $pageId, XTS_Google_Service_Blogger_Page $postBody, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'pageId' => $pageId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "XTS_Google_Service_Blogger_Page");
  }
  /**
  ...
  public function publish($blogId, $pageId, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'pageId' => $pageId);
    $params = array_merge($params, $optParams);
    return $this->call('publish', array($params), "XTS_Google_Service_Blogger_Page");
  }
  /**
  ...
  public function revert($blogId, $pageId, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'pageId' => $pageId);
    $params = array_merge($params, $optParams);
    return $this->call('revert', array($params), "XTS_Google_Service_Blogger_Page");
  }
  /**
   ...
   * @return Google_Service_Blogger_Page
   */
  public function update($blogId, $pageId, XTS_Google_Service_Blogger_Page $postBody, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'pageId' => $pageId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "XTS_Google_Service_Blogger_Page");
  }
}

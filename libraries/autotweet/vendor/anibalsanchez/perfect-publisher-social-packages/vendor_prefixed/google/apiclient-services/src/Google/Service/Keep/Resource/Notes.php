 ...
 *  </code>
 */
class XTS_Google_Service_Keep_Resource_Notes extends XTS_Google_Service_Resource
{
  /**
   * Creates a new note. (notes.create)
   *
   * @param Google_Service_Keep_Note $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_Keep_Note
   */
  public function create(XTS_Google_Service_Keep_Note $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "XTS_Google_Service_Keep_Note");
  }
  /**
  ...
  public function delete($name, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "XTS_Google_Service_Keep_KeepEmpty");
  }
  /**
  ...
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "XTS_Google_Service_Keep_Note");
  }
  /**
   ...
   * @return Google_Service_Keep_ListNotesResponse
   */
  public function listNotes($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "XTS_Google_Service_Keep_ListNotesResponse");
  }
}

 ...
 *  </code>
 */
class XTS_Google_Service_Keep_Resource_Media extends XTS_Google_Service_Resource
{
  /**
  ...
  public function download($name, $optParams = array())
  {
    ...
    return $this->call('download', array($params), "XTS_Google_Service_Keep_Attachment");
  }
}

...
class XTS_Google_Service_Blogger_BlogList extends XTS_Google_Collection
{
  protected $collection_key = 'items';
  protected $blogUserInfosType = 'XTS_Google_Service_Blogger_BlogUserInfo';
  protected $blogUserInfosDataType = 'array';
  protected $itemsType = 'XTS_Google_Service_Blogger_Blog';

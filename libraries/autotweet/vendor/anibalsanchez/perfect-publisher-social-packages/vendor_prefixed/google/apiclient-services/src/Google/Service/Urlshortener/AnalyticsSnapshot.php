...
class XTS_Google_Service_Urlshortener_AnalyticsSnapshot extends XTS_Google_Collection
{
  protected $collection_key = 'referrers';
  protected $browsersType = 'XTS_Google_Service_Urlshortener_StringCount';
  protected $browsersDataType = 'array';
  protected $countriesType = 'XTS_Google_Service_Urlshortener_StringCount';
  protected $countriesDataType = 'array';
  public $longUrlClicks;
  protected $platformsType = 'XTS_Google_Service_Urlshortener_StringCount';
  protected $platformsDataType = 'array';
  protected $referrersType = 'XTS_Google_Service_Urlshortener_StringCount';

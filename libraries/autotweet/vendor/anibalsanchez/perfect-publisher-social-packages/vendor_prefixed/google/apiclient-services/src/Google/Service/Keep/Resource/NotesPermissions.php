 ...
 *  </code>
 */
class XTS_Google_Service_Keep_Resource_NotesPermissions extends XTS_Google_Service_Resource
{
  /**
   ...
   */
  public function batchCreate($parent, XTS_Google_Service_Keep_BatchCreatePermissionsRequest $postBody, $optParams = array())
  {
    $params = array('parent' => $parent, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('batchCreate', array($params), "XTS_Google_Service_Keep_BatchCreatePermissionsResponse");
  }
  /**
   ...
   */
  public function batchDelete($parent, XTS_Google_Service_Keep_BatchDeletePermissionsRequest $postBody, $optParams = array())
  {
    $params = array('parent' => $parent, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('batchDelete', array($params), "XTS_Google_Service_Keep_KeepEmpty");
  }
}

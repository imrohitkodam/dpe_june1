...
class XTS_Google_Service_Pagespeedonline_PagespeedApiLoadingExperienceV5MetricsElement extends XTS_Google_Collection
{
  protected $collection_key = 'distributions';
  public $category;
  protected $distributionsType = 'XTS_Google_Service_Pagespeedonline_PagespeedApiLoadingExperienceV5MetricsElementDistributions';

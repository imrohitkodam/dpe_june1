 ...
 * @author Google, Inc.
 */
class XTS_Google_Service_Keep extends XTS_Google_Service
{
  ...
  public function __construct(XTS_Google_Client $client, $rootUrl = null)
  {
    ...
    $this->media = new XTS_Google_Service_Keep_Resource_Media(
        $this,
        $this->serviceName,
        'media',
        array(
    ...
    $this->notes = new XTS_Google_Service_Keep_Resource_Notes(
        $this,
        $this->serviceName,
        'notes',
        array(
    ...
    $this->notes_permissions = new XTS_Google_Service_Keep_Resource_NotesPermissions(
        $this,
        $this->serviceName,
        'permissions',
        array(

...
class XTS_Google_Service_Keep_Note extends XTS_Google_Collection
{
  protected $collection_key = 'permissions';
  protected $attachmentsType = 'XTS_Google_Service_Keep_Attachment';
  protected $attachmentsDataType = 'array';
  protected $bodyType = 'XTS_Google_Service_Keep_Section';
  protected $bodyDataType = '';
  public $createTime;
  public $name;
  protected $permissionsType = 'XTS_Google_Service_Keep_Permission';
   ...
   */
  public function setBody(XTS_Google_Service_Keep_Section $body)
  {
    $this->body = $body;
  }
  /**

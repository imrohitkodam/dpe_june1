 ...
 *  </code>
 */
class XTS_Google_Service_Blogger_Resource_Blogs extends XTS_Google_Service_Resource
{
  /**
  ...
  public function get($blogId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "XTS_Google_Service_Blogger_Blog");
  }
  /**
  ...
  public function getByUrl($url, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('getByUrl', array($params), "XTS_Google_Service_Blogger_Blog");
  }
  /**
  ...
  public function listByUser($userId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('listByUser', array($params), "XTS_Google_Service_Blogger_BlogList");
  }
}

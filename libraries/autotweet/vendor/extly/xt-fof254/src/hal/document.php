...
class XTF0FHalDocument
{
	 ...
	 *                                  a "self" link.
	 * @param   XTF0FHalLink  $link       The actual link object
	 ...
	 */
	public function addLink($rel, XTF0FHalLink $link, $overwrite = true)
	{
	 ...
	 * @return  boolean
	 */
	public function addEmbedded($rel, XTF0FHalDocument $document, $overwrite = true)
	{

...
abstract class XTF0FPlatform implements XTF0FPlatformInterface
{
	...
	{
		if ($instance instanceof XTF0FPlatformInterface || is_null($instance))
		{
	 ...
	 * @param   \Joomla\Input\Input  $input         The \Joomla\Input\Input object with the request (input) data

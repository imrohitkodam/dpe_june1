...
abstract class XTF0FRenderAbstract
{
	 ...
	 */
	public function renderForm(XTF0FForm &$form, XTF0FModel $model, \Joomla\Input\Input $input, $formType = null, $raw = false)
	{
		if (is_null($formType))
		{
	 ...
	 * @return  string    The HTML rendering of the form
	 */
	abstract protected function renderFormBrowse(XTF0FForm &$form, XTF0FModel $model, \Joomla\Input\Input $input);
	 ...
	 * @return  string    The HTML rendering of the form
	 */
	abstract protected function renderFormRead(XTF0FForm &$form, XTF0FModel $model, \Joomla\Input\Input $input);
	 ...
	 * @return  string    The HTML rendering of the form
	 */
	abstract protected function renderFormEdit(XTF0FForm &$form, XTF0FModel $model, \Joomla\Input\Input $input);
	 ...
	 * @return  string    The HTML rendering of the form
	 */
	abstract protected function renderFormRaw(XTF0FForm &$form, XTF0FModel $model, \Joomla\Input\Input $input, $formType);
	 ...
	 */
	protected function renderFieldset(stdClass &$fieldset, XTF0FForm &$form, XTF0FModel $model, \Joomla\Input\Input $input, $formType, $showHeader = true)
	{

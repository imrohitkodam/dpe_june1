...
class XTF0FRenderStrapper extends XTF0FRenderAbstract
{
	 ...
	 * @param   \Joomla\Input\Input  $input   The input array (request parameters)
	...
	public function preRender($view, $task, $input, $config = array())
	{
		...
		$majorVersion = JVersion::MINOR_VERSION;
	...
	public function postRender($view, $task, $input, $config = array())
	{
		...
		if ($format != 'html' || XTF0FPlatform::getInstance()->isCli())
		{
			return;
		}
...
JS;
	 ...
	 */
	protected function renderFormBrowse(XTF0FForm &$form, XTF0FModel $model, \Joomla\Input\Input $input)
	{
		$html = '';
...
HTML;
		...
		if (XTF0FPlatform::getInstance()->isFrontend() && ($input->getCmd('Itemid', 0) != 0))
		{
	 ...
	 * @return  string    The HTML rendering of the form
	 */
	protected function renderFormRead(XTF0FForm &$form, XTF0FModel $model, \Joomla\Input\Input $input)
	{
	 ...
	 * @return  string    The HTML rendering of the form
	 */
	protected function renderFormEdit(XTF0FForm &$form, XTF0FModel $model, \Joomla\Input\Input $input)
	{
	 ...
	 * @return  string    The HTML rendering of the form
	 */
	protected function renderFormRaw(XTF0FForm &$form, XTF0FModel $model, \Joomla\Input\Input $input, $formType)
	{
		$html = '';
		$tabHtml = array();
	 ...
	 */
	protected function renderFieldset(stdClass &$fieldset, XTF0FForm &$form, XTF0FModel $model, \Joomla\Input\Input $input, $formType, $showHeader = true, &$innerHtml = null)
	{
		$html = '';

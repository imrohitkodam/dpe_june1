...
class XTF0FLessParser
{
	...
	public function __construct($lessc, $sourceName = null)
	{
		...
		{
			self::$operatorString = '(' . implode('|', array_map(array('XTF0FLess', 'preg_quote'), array_keys(self::$precedence))) . ')';
	...
	protected function isDirective($dirname, $directives)
	{
		...
		$pattern = implode("|", array_map(array("XTF0FLess", "preg_quote"), $directives));
	...
	protected function openString($end, &$out, $nestingOpen = null, $rejectStrs = null)
	{
		...
		$stop = array("'", '"', "@{", $end);
		$stop = array_map(array("XTF0FLess", "preg_quote"), $stop);

...
class XTF0FLess
{
	...
	protected function injectVariables($args)
	{
		$this->pushEnv();
		/** XTF0F -- BEGIN CHANGE * */
		$parser = new XTF0FLessParser($this, __METHOD__);
		/** XTF0F -- END CHANGE * */
	...
	public function compileFile($fname, $outFname = null)
	{
		...
		{
			/** XTF0F - BEGIN CHANGE * */
			return XTF0FPlatform::getInstance()->getIntegrationObject('filesystem')->fileWrite($outFname, $out);
			/** XTF0F - END CHANGE * */
		}
	...
	{
		/** XTF0F -- BEGIN CHANGE * */
		$parser = new XTF0FLessParser($this, $name);
		/** XTF0F -- END CHANGE * */

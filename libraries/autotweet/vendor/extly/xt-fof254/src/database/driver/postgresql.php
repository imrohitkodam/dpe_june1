...
class XTF0FDatabaseDriverPostgresql extends XTF0FDatabaseDriver
{
	 ...
	 *
	 * @param   boolean  $new    False to return the last query set, True to return a new XTF0FDatabaseQuery object.
	 * @param   boolean  $asObj  False to return last query as string, true to get XTF0FDatabaseQueryPostgresql object.
	 *

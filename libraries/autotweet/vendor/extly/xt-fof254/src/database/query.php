 ...
 * @property-read   XTF0FDatabaseQueryElement  $type
 * @property-read   XTF0FDatabaseQueryElement  $select
 * @property-read   XTF0FDatabaseQueryElement  $group
 * @property-read   XTF0FDatabaseQueryElement  $having
 */
abstract class XTF0FDatabaseQuery
{
	 ...
	 * Class constructor.
	 *
	 * @param   XTF0FDatabaseDriver  $db  The database driver.
	 *
	 * @since   11.1
	 */
	public function __construct(XTF0FDatabaseDriver $db = null)
	{
		$this->db = $db;
	}
	...
	public function having($conditions, $glue = 'AND')
	{
		if (is_null($this->having))
		{
			...
			$this->having = new XTF0FDatabaseQueryElement('HAVING', $conditions, " $glue ");
		}
		else
		{
	...
	public function where($conditions, $glue = 'AND')
	{
		...
		{
			$glue = strtoupper($glue);
			$this->where = new XTF0FDatabaseQueryElement('WHERE', $conditions, " $glue ");
		}
		else
		{

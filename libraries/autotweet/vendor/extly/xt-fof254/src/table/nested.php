...
class XTF0FTableNested extends XTF0FTable
{
	 ...
	 * @throws RuntimeException
	 */
	public function insertAsFirstChildOf(XTF0FTableNested &$parentNode)
	{
	 ...
	 * @throws RuntimeException
	 */
	public function insertAsLastChildOf(XTF0FTableNested &$parentNode)
	{
        if($parentNode->lft >= $parentNode->rgt)
        {
            throw new RuntimeException('Invalid position values for the parent node');
	 ...
	 *
     * @codeCoverageIgnore
	 * @param XTF0FTableNested $parentNode
	 *
	 * @return $this for chaining
	 *
	 * @throws Exception
	 */
	public function insertAsChildOf(XTF0FTableNested &$parentNode)
	{
	 ...
	 * @throws RuntimeException
	 */
	public function insertLeftOf(XTF0FTableNested &$siblingNode)
	{
	 ...
	 * @throws RuntimeException
	 */
	public function insertRightOf(XTF0FTableNested &$siblingNode)
	{
        if($siblingNode->lft >= $siblingNode->rgt)
        {
            throw new RuntimeException('Invalid position values for the sibling node');
	 ...
	 *
     * @codeCoverageIgnore
	 * @param XTF0FTableNested $siblingNode
	 *
	 * @return $this for chaining
	 */
	public function insertAsSiblingOf(XTF0FTableNested &$siblingNode)
	{
	...
	public function moveLeft()
	{
		...
		// Move the node
		if (is_object($leftSibling) && ($leftSibling instanceof XTF0FTableNested))
		{
	...
	public function moveRight()
	{
		...
		// Move the node
		if (is_object($rightSibling) && ($rightSibling instanceof XTF0FTableNested))
		{
	 ...
	 * @throws RuntimeException
	 */
	public function moveToLeftOf(XTF0FTableNested $siblingNode)
	{
	 ...
	 * @throws RuntimeException
	 */
	public function moveToRightOf(XTF0FTableNested $siblingNode)
	{
        // Sanity checks on current and sibling node position
        if($this->lft >= $this->rgt)
        {
	 ...
	 * @return $this for chaining
	 */
	public function makeNextSiblingOf(XTF0FTableNested $siblingNode)
	{
	 ...
	 * @return $this for chaining
	 */
	public function makeSiblingOf(XTF0FTableNested $siblingNode)
	{
	 ...
	 * @return $this for chaining
	 */
	public function makePreviousSiblingOf(XTF0FTableNested $siblingNode)
	{
	 ...
	 * @throws Exception
	 */
	public function makeFirstChildOf(XTF0FTableNested $parentNode)
	{
        // Sanity checks on current and sibling node position
        if($this->lft >= $this->rgt)
        {
	 ...
	 * @throws RuntimeException
	 */
	public function makeLastChildOf(XTF0FTableNested $parentNode)
	{
        // Sanity checks on current and sibling node position
        if($this->lft >= $this->rgt)
        {
	 ...
	 * @return $this for chaining
	 */
	public function makeChildOf(XTF0FTableNested $parentNode)
	{
	...
	public function getParent()
	{
		...
		if (empty($this->treeParent) || !is_object($this->treeParent) || !($this->treeParent instanceof XTF0FTableNested))
		{
			$db = $this->getDbo();
	 ...
	 *
	 * @param XTF0FTableNested $otherNode
	 *
     * @throws  RuntimeException
     *
	 * @return bool
	 */
	public function isDescendantOf(XTF0FTableNested $otherNode)
	{
        // Sanity checks on current node position
        if($this->lft >= $this->rgt)
        {
	 ...
	 * @return bool
	 */
	public function isSelfOrDescendantOf(XTF0FTableNested $otherNode)
	{
        // Sanity checks on current node position
        if($this->lft >= $this->rgt)
        {
	 ...
	 * @return bool
	 */
	public function isAncestorOf(XTF0FTableNested $otherNode)
	{
	 ...
	 * @return bool
	 */
	public function isSelfOrAncestorOf(XTF0FTableNested $otherNode)
	{
	 ...
	 *
	 * @param XTF0FTableNested $node
	 *
     * @throws  RuntimeException
     *
	 * @return bool
	 */
	public function equals(XTF0FTableNested &$node)
	{
        // Sanity checks on current node position
        if($this->lft >= $this->rgt)
        {
	 ...
	 * @return bool
	 */
	public function insideSubtree(XTF0FTableNested $otherNode)
	{
	 ...
	 * @return bool
	 */
	public function inSameScope(XTF0FTableNested $otherNode)
	{
		if ($this->isLeaf())
		{
	 ...
	 * @return void
	 */
	public function withoutNode(XTF0FTableNested $node)
	{
		$db = $this->getDbo();
	...
	public function getRoot()
	{
		...
		if (empty($this->treeRoot) || !is_object($this->treeRoot) || !($this->treeRoot instanceof XTF0FTableNested))
		{
			$this->treeRoot = null;
	...
	public function get($limitstart = 0, $limit = 0)
	{
		...
		$dataCollection = XTF0FDatabaseIterator::getIterator($db->name, $cursor, null, $this->config['_table_class']);

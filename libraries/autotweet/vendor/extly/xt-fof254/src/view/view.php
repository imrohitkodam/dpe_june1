...
abstract class XTF0FView extends XTF0FUtilsObject
{
	...
	{
		XTF0FPlatform::getInstance()->logDeprecated(__CLASS__ . '::' . __METHOD__ . ' is deprecated. Use native PHP syntax.');
	...
	{
		XTF0FPlatform::getInstance()->logDeprecated(__CLASS__ . '::' . __METHOD__ . ' is deprecated. Override XTF0FView::escape() instead.');
	 ...
	 *
	 * @param   XTF0FRenderAbstract  &$renderer  The render class to use
	 *
	 * @return  void
	 */
	public function setRenderer(XTF0FRenderAbstract &$renderer)
	{
		...
		if (empty(self::$renderers) || !class_exists('XTF0FRenderJoomla', false))
		{
			...
			if (!empty($renderFiles))
			{
				foreach ($renderFiles as $filename)
				{
					...
					$camel = XTF0FInflector::camelize($filename);
	 ...
	 *
	 * @param   XTF0FRenderAbstract  &$renderer  The render object to register
	 *
	 * @return  void
	 */
	public static function registerRenderer(XTF0FRenderAbstract &$renderer)
	{

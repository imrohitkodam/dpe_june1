...
class XTF0FForm extends JForm
{
	...
	public static function getInstance($name, $data = null, $options = array(), $replace = true, $xpath = false)
	{
		...
		if (!isset($forms[$name]))
		{
			...
			$forms[$name] = new XTF0FForm($name, $options);
	 ...
	 *
	 * @param   XTF0FModel  &$model  The model to attach to the form
	 *
	 * @return  void
	 */
	public function setModel(XTF0FModel &$model)
	{
		$this->model = $model;
	}
	 ...
	 *
	 * @param   XTF0FView  &$view  The view to attach to the form
	 *
	 * @return  void
	 */
	public function setView(XTF0FView &$view)
	{
		$this->view = $view;
	}

...
use XTP_BUILD\League\Uri\Interfaces\HierarchicalComponent;
use XTP_BUILD\League\Uri\Types\ImmutableCollectionTrait;
use XTP_BUILD\League\Uri\Types\ImmutableComponentTrait;

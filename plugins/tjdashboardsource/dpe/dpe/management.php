...
class DpeManagementDatasource
{
	public $dataSourceName = "PLG_TJDASHBOARDSOURCE_DPE_MANAGEMENT";
	...
	{
		$items = [];
		$items['data'] = ['widgetlabel' => Text::_('PLG_TJDASHBOARDSOURCE_DPE_MANAGEMENT_DESC')
		];

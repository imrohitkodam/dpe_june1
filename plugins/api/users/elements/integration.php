 ...
 * @since  1.0.0
 */
class FormFieldIntegration extends FormField
{
	/**
	...
	public function fetchElement($name, $value, $node, $control_name)
	{
		...
		$options[] = JHTML::_('select.option', 'joomla', Text::_('PLG_USER_API_JOOMLA'));
	/*	$options[] = JHTML::_('select.option', 'jomsocial', JText::_('PLG_USER_API_JOMSOCIAL'));	*/
		$options[] = JHTML::_('select.option', 'easysocial', Text::_('PLG_USER_API_EASYSOCIAL'));

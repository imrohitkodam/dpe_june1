 ...
 * @since  2.5
 */
class PlgFinderTjlmsfinder extends FinderIndexerAdapter
{
	/**
	 ...
	 * @since  2.5
	 */
	protected $table = '#__tjlms_courses';
	...
	{
		// Make sure we're handling com_tjlms categories
		if ($extension == 'com_tjlms')
		{
	...
	protected function index(FinderIndexerResult $item, $format = 'html')
	{
		...
		$item->route = TjlmscourseHelperRoute::getCourseRoute($item->id, $item->catslug, $item->language);

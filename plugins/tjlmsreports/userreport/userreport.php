...
class PlgTjlmsreportsUserreport extends JPlugin
{
	/**
	...
	public function __construct(&$subject, $config)
	{
		...
		$extension    = 'plg_tjlmsreports_userreport';
		$base_dir     = JPATH_BASE;
		$language_tag = 'en-GB';
		$reload       = true;
...
/**
	...
	*/
	 ...
	 * @since 1.0.0
	 */
	public function plguserreportGetData($filters, $colNames, $rows_to_fetch, $limit_start, $sortCol, $sortOrder)
	{
		$db        = JFactory::getDBO();
	 ...
	 * @since    1.0
	 */
	public function plguserreportRenderPluginHTML($filters, $colNames, $rows_to_fetch, $limit_start, $sortCol, $sortOrder, $action, $layout = 'default')
	{
		// Get data
		$resultData = $this->plguserreportGetData($filters, $colNames, $rows_to_fetch, $limit_start, $sortCol, $sortOrder);
	...
	{
		$ColArray = array(
			'PLG_TJLMSREPORTS_USERREPORT_ID' => 'id',
			'PLG_TJLMSREPORTS_USERREPORT_NAME' => 'name',
			'PLG_TJLMSREPORTS_USERREPORT_USERNAME' => 'username',
			'PLG_TJLMSREPORTS_USERREPORT_EMAIL' => 'email',
			'PLG_TJLMSREPORTS_USERREPORT_BLOCK' => 'block',
			'PLG_TJLMSREPORTS_USERREPORT_USER_GROUP' => 'user_group'
		);

		$ColArray['PLG_TJLMSREPORTS_USERREPORT_ENROLLED_COURSES'] = 'enrolled_courses';
		$ColArray['PLG_TJLMSREPORTS_USERREPORT_PENDING_ENROLLMENT'] = 'pending_enrollment';
		$ColArray['PLG_TJLMSREPORTS_USERREPORT_TOTALCOMPLETEDCOURSES'] = 'totalCompletedCourses';
		$ColArray['PLG_TJLMSREPORTS_USERREPORT_INCOMPLETEDCOURSES'] = 'inCompletedCourses';
		$ColArray['PLG_TJLMSREPORTS_USERREPORT_TIMESPENTONLESSON'] = 'timeSpentOnLesson';

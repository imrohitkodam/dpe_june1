...
class PlgTjlmsreportsCoursereport extends JPlugin
{
	/**
	...
	public function __construct(&$subject, $config)
	{
		...
		$extension    = 'plg_tjlmsreports_coursereport';
		$base_dir     = JPATH_BASE;
		$language_tag = 'en-GB';
		$reload       = true;
...
/**
	...
	*/
	 ...
	 * @since 1.0.0
	 */
	public function plgcoursereportGetData($filters, $colNames, $rows_to_fetch, $limit_start, $sortCol, $sortOrder)
	{
		$db        = JFactory::getDBO();
		...
		{
			$sortCol   = $mainframe->getUserState("com_tjlms.coursereport_table_sortCol", '');
			$sortOrder = $mainframe->getUserState("com_tjlms.coursereport_table_sortOrder", '');
		}
	 ...
	 * @since    1.0
	 */
	public function plgcoursereportRenderPluginHTML($filters, $colNames, $rowsToFetch, $limit_start, $sortCol, $sortOrder, $action, $layout = 'default')
	{
		// Get data
		$resultData = $this->plgcoursereportGetData($filters, $colNames, $rowsToFetch, $limit_start, $sortCol, $sortOrder);
	...
	{
		$ColArray = array(
			'PLG_TJLMSREPORTS_COURSEREPORT_ID' => 'id',
			'PLG_TJLMSREPORTS_COURSEREPORT_TITLE' => 'title',
			'PLG_TJLMSREPORTS_COURSEREPORT_TYPE' => 'type',
			'PLG_TJLMSREPORTS_COURSEREPORT_ACCESS' => 'access',
			'PLG_TJLMSREPORTS_COURSEREPORT_CAT_TITLE' => 'cat_title',
			'PLG_TJLMSREPORTS_COURSEREPORT_LESSONS_CNT' => 'lessons_cnt',
			'PLG_TJLMSREPORTS_COURSEREPORT_ENROLLED_USERS' => 'enrolled_users'
		);

		$ColArray['PLG_TJLMSREPORTS_COURSEREPORT_PENDING_ENROLLMENT'] = 'pending_enrollment';
		$ColArray['PLG_TJLMSREPORTS_COURSEREPORT_TOTALCOMPLETEDUSERS'] = 'totalCompletedUsers';
		$ColArray['PLG_TJLMSREPORTS_COURSEREPORT_LIKECNT'] = 'likeCnt';
		$ColArray['PLG_TJLMSREPORTS_COURSEREPORT_DISLIKECNT'] = 'dislikeCnt';
		$ColArray['PLG_TJLMSREPORTS_COURSEREPORT_COMMNETSCNT'] = 'commnetsCnt';
		$ColArray['PLG_TJLMSREPORTS_COURSEREPORT_RECOMMENDCNT'] = 'recommendCnt';
		$ColArray['PLG_TJLMSREPORTS_COURSEREPORT_ASSIGNCNT'] = 'assignCnt';

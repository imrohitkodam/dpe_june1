				...
				<tr>
					<?php
							foreach ($colToshow as $eachColumn)
							{
								...
								$sortCol = $mainframe->getUserState( "com_tjlms.coursereport_table_sortCol", 'id' );
								$sortOrder = $mainframe->getUserState( "com_tjlms.coursereport_table_sortOrder", 'asc' );
								...
								if ($sortCol == $eachColumn && !empty($sortCol) && !empty($sortOrder) )
								{
									...
									<th class="th_<?php echo $eachColumn; ?> left <?php echo $class; ?>">
										...
										<?php $calHeading = 'PLG_TJLMSREPORTS_COURSEREPORT_' . $calHeading; ?>

										<a href="#" onclick="sortColumns(this); return false;" class="hasTooltip" title="<?php echo JText::_('PLG_TJLMSREPORTS_COURSEREPORT_SORT'); ?>" data-value="<?php echo $eachColumn; ?>"><?php echo JText::_($calHeading); ?><?php echo $icon; ?></a>

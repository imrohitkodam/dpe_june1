...
class PlgContentJLike_Events extends JPlugin
{
	 ...
	 */
	public function onAfterJlikeeventContentCheckforReminder($user_id, $element_id)
	{
		$db = JFactory::getDBO();
	 ...
	 * @since  1.0.0
	 */
	public function getjlike_eventsOwnerDetails($course_id)
	{
	...
	public function onBeforeDisplaylike($context, $event, $show_comments = -1, $show_like_buttons = 0)
	{
		...
		{
			$show_like_buttons = -1;
			$jlike_buttons = $this->jlike_eventsGetParams()->get('allow_like');

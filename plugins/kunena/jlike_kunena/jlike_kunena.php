...
class plgKunenajlike_kunena extends JPlugin {
...
//~
		...
		return;
		JRequest::setVar ( 'data', json_encode ( array ('cont_id' => $cont_id, 'element' => $element, 'title' => $topic->subject, 'url' => $route,'plg_name'=>'jlike_kunena','show_comments'=>$show_comments, 'show_like_buttons'=>$show_like_buttons ) ) );
		require_once(JPATH_SITE.'/'.'components/com_jlike/helper.php');

...
class plgK2Jlike_k2 extends K2Plugin
{
	...
	function onK2AfterDisplayContent( &$item, &$params, $limitstart) {
		...
		$show_like_buttons = 1;
		JRequest::setVar ( 'data', json_encode ( array ('cont_id'=>$item->id,'element' => $element, 'title' => $item->title, 'url' => $item_route,'plg_name'=>'jlike_k2','show_comments'=>$show_comments, 'show_like_buttons'=>$show_like_buttons ) ) );
	...
	function getjlike_k2OwnerDetails($cont_id)
	{
		$db=JFactory::getDBO();

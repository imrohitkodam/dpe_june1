...
class TjqueueDpeOnboard
{
	...
	public function consume($message)
	{
		...
		$messageData             = json_decode($messageData['scalar']);

		$onBoardUsersModel = DPE::model('users', array('ignore_request' => true));

		/** @scrutinizer ignore-call */
		$onBoardUsersModel->onboardUsersTodoAssign($messageData);

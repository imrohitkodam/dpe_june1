...
class TjqueueJlikeResendtodos
{
	...
	public function consume($message)
	{
		...
		$recommendationformModel = JLIKE::model('recommendation', array('ignore_request' => true));

		/** @scrutinizer ignore-call */
		$recommendationformModel->resendTodo($messageData);

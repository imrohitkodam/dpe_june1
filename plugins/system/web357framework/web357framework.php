		...
		public function onAfterInitialise()
		{
			...
			if ($app->isClient('administrator'))
			{
				...
				))
				{
					...
					{
						Factory::getDocument()->addScript(JURI::root(true).'/media/plg_system_web357framework/js/jquery-1.10.2.min.js');
					}
					...
					// js
					Factory::getDocument()->addScript(JURI::root(true).'/media/plg_system_web357framework/js/script.min.js?v=1.8.1_20201201164227');

					// css
					Factory::getDocument()->addStyleSheet(JURI::root(true).'/media/plg_system_web357framework/css/style.min.css?v=1.8.1_20201201164227');
				}
			}
		}

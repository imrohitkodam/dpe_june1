...
class Functions
{
    ...
    public static function showFooter($extension, $extension_real_name)
    {
        ...
        $pro_link = '//www.web357.com/joomla-pricing?utm_source=CLIENT&utm_medium=CLIENT-ProLink-Backend-Footer-'.$extension_clean_name.'-Web357&utm_content=CLIENT-ProLink-Backend-Footer-'.$extension_clean_name.'&utm_campaign=prolinkbackendfooter-'.strtoupper($extension_clean_name);
        ?>
            ...
            <div class="w357-footer">
                ...
                <?php if ($show_copyright): ?>
                    <div class="w357-footer-logo">
                        Powered by <a href="//www.web357.com" target="_blank">

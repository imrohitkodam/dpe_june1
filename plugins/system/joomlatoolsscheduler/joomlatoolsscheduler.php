...
class PlgSystemJoomlatoolsscheduler extends CMSPlugin
{
    ...
    static public function handleLogs($logs)
    {
        try {
            ...
            $path = rtrim(Factory::getConfig()->get('log_path'), '/').'/'.$file;
    ...
    public function canRun()
    {
        return (@$_SERVER['REQUEST_METHOD'] === 'GET'
            && !Factory::getConfig()->get('offline')
            && Factory::getDocument()->getType() === 'html'
            && !in_array(Factory::getApplication()->input->get('option', 'cmd'), static::$_exclude));
    }

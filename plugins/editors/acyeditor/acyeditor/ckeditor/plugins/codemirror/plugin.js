    ...
    CKEDITOR.plugins.add('codemirror', {
        ...
        init: function (editor) {
            ...
            function getCodeMirrorScripts() {
                var scriptFiles = [rootPath + 'js/addons.min.js'];

                switch (config.mode) {
                case "bbcode":
                    {
                        scriptFiles.push(rootPath + 'js/bbcode.min.js');
                    }

                    break;
                case "bbcodemixed":
                        {
                            scriptFiles.push(rootPath + 'js/mixed.min.js');
                        }

                        break;
                case "htmlmixed":
                    {
                        scriptFiles.push(rootPath + 'js/htmlmixed.min.js');
                    }
                ...
                case "application/x-httpd-php":
                    {
                        scriptFiles.push(rootPath + 'js/php.min.js');
                    }

                    break;
                case "text/javascript":
                    {
                        scriptFiles.push(rootPath + 'js/javascript.min.js');
                    }
                ...
                if (config.enableSearchTools) {
                    scriptFiles.push(rootPath + 'js/search.min.js');
                }
                return scriptFiles;
            }

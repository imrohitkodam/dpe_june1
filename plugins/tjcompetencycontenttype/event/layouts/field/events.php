 ...
 *
 * @var   string   $eventName      The course name
...
$uri = new JUri('index.php?option=com_jticketing&view=events&layout=modal&tmpl=component&required=0&field={field-user-id}&fieldView=1');
...
if ($this->escape($eventName) === JText::_('COM_COMPETENCY_COMPETENCY_SKILLCONTENTMAP_FORM_SELECT_CONTENT_TYPE_EVENT'))
{
	$eventName = '';
}

$inputAttributes = array(
	'type' => 'text', 'id' => $id, 'class' => 'field-user-input-name', 'value' => $this->escape($eventName)
);
...
if (!$readonly)
{
	$inputAttributes['placeholder'] = JText::_('COM_COMPETENCY_COMPETENCY_SKILLCONTENTMAP_FORM_SELECT_CONTENT_TYPE_EVENT');
}
	...
	<div class="input-append">
		...
		<?php if (!$readonly) : ?>
			<button
				...
				title="<?php echo JText::_('COM_COMPETENCY_COMPETENCY_SKILLCONTENTMAP_FORM_SELECT_CONTENT_TYPE_EVENT'); ?>"
				aria-label="<?php echo JText::_('COM_COMPETENCY_COMPETENCY_SKILLCONTENTMAP_FORM_SELECT_CONTENT_TYPE_EVENT'); ?>"
				>
			...
			<?php echo JHtml::_(
				...
				'eventsModal_' . $id,
				array(
					'title'       => JText::_('COM_COMPETENCY_COMPETENCY_SKILLCONTENTMAP_FORM_SELECT_CONTENT_TYPE_EVENT'),
					'closeButton' => true,

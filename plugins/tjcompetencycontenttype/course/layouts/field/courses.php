 ...
 *
 * @var   string   $courseName      The course name
...
$uri = new JUri('index.php?option=com_tjlms&view=courses&layout=modal&tmpl=component&required=0&field={field-user-id}&fieldView=1');
...
if ($this->escape($courseName) === JText::_('COM_COMPETENCY_COMPETENCY_SKILLCONTENTMAP_FORM_SELECT_CONTENT_TYPE_COURSE'))
{
	$courseName = '';
}

$inputAttributes = array(
	'type' => 'text', 'id' => $id, 'class' => 'field-user-input-name', 'value' => $this->escape($courseName)
);
...
if (!$readonly)
{
	$inputAttributes['placeholder'] = JText::_('COM_COMPETENCY_COMPETENCY_SKILLCONTENTMAP_FORM_SELECT_CONTENT_TYPE_COURSE');
}
	...
	<div class="input-append">
		...
		<?php if (!$readonly) : ?>
			<button
				...
				title="<?php echo JText::_('COM_COMPETENCY_COMPETENCY_SKILLCONTENTMAP_FORM_SELECT_CONTENT_TYPE_COURSE'); ?>"
				aria-label="<?php echo JText::_('COM_COMPETENCY_COMPETENCY_SKILLCONTENTMAP_FORM_SELECT_CONTENT_TYPE_COURSE'); ?>"
				>
			...
			<?php echo JHtml::_(
				...
				'coursesModal_' . $id,
				array(
					'title'       => JText::_('COM_COMPETENCY_COMPETENCY_SKILLCONTENTMAP_FORM_SELECT_CONTENT_TYPE_COURSE'),
					'closeButton' => true,

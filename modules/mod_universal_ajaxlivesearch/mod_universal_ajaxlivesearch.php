...
if(is_object($theme)){ //For 1.6, 1.7, 2.5
  $params->merge(new Registry($params->get('theme')));
...
$searchformurl = Route::_(JURI::root(true).'/'.(version_compare(JVERSION,'1.6.0','>=') ? 'index' : 'index2').".php");
...
*/
$comparams = ComponentHelper::getParams('com_search');
$keywordSuggestion = 0;
...
dojo.addOnLoad(function(){
    document.search = new AJAXSearch".$theme."({
      ...
      showIntroText: '$intro',
      scount: '$scount',
      lang: '".Factory::getApplication()->input->getCmd('lang')."',
      stext: '$stext',
      moduleId : '$module->id',
...
<div id="offlajn-ajax-search<?php echo $module->id; ?>" class="<?php echo $params->get('moduleclass_sfx') ?>">
  ...
  ?>
  <form id="search-form<?php echo $module->id; ?>" action="<?php echo Route::_('index.php?'.$formUrl.$itemid); ?>" method="get" onSubmit="return false;">
